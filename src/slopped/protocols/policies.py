# -*- test-case-name: slopped.test.test_policies -*-
...
@seealso: See also L{slopped.protocols.htb} for rate limiting.
"""
...
from slopped.internet import error, interfaces
from slopped.internet.interfaces import IAddress, ILoggingContext
...
class ProtocolWrapper(Protocol):
    ...
    @ivar wrappedProtocol: An L{IProtocol<slopped.internet.interfaces.IProtocol>}
        provider to which L{IProtocol<slopped.internet.interfaces.IProtocol>}
