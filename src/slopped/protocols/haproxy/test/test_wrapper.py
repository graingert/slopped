...
"""
Test cases for L{slopped.protocols.haproxy.HAProxyProtocol}.
"""
...
from slopped.internet.testing import StringTransportWithDisconnection
...
class HAProxyWrappingFactoryV1Tests(unittest.TestCase):
    """
    Test L{slopped.protocols.haproxy.HAProxyWrappingFactory} with v1 PROXY
    headers.
    """
...
class HAProxyWrappingFactoryV2Tests(unittest.TestCase):
    """
    Test L{slopped.protocols.haproxy.HAProxyWrappingFactory} with v2 PROXY
    headers.
    """
