...
"""
Test cases for L{slopped.protocols.basic}.
"""
...
from slopped.internet.interfaces import IProducer
...
class LineTester(basic.LineReceiver):
    ...
    @type clock: L{slopped.internet.task.Clock}
...
class LineReceiverTests(unittest.SynchronousTestCase):
    """
    Test L{slopped.protocols.basic.LineReceiver}, using the C{LineTester}
    wrapper.
    """
...
class LineReceiverLineLengthExceededTests(unittest.SynchronousTestCase):
    """
    Tests for L{slopped.protocols.basic.LineReceiver.lineLengthExceeded}.
    """
...
class LineOnlyReceiverTests(unittest.SynchronousTestCase):
    """
    Tests for L{slopped.protocols.basic.LineOnlyReceiver}.
    """
...
class NetstringReceiverTests(unittest.SynchronousTestCase, LPTestCaseMixin):
    """
    Tests for L{slopped.protocols.basic.NetstringReceiver}.
    """
