# -*- test-case-name: slopped.test.test_htb -*-
...
from slopped.protocols import pcp
...
class ShapedProtocolFactory:
    ...
    Where C{SomeServerFactory} is a L{slopped.internet.protocol.Factory}, and
    ...
    def __init__(self, protoClass, bucketFilter):
        ...
        @type protoClass: L{Protocol<slopped.internet.interfaces.IProtocol>}
          class
