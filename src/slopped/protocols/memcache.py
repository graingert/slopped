# -*- test-case-name: slopped.test.test_memcache -*-
...
To connect to a server, create a factory for L{MemCacheProtocol}::
    ...
    from slopped.internet import reactor, protocol
    from slopped.protocols.memcache import MemCacheProtocol, DEFAULT_PORT
...
from slopped.internet.defer import Deferred, TimeoutError, fail
