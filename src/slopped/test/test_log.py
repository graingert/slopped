...
"""
Tests for L{slopped.python.log}.
"""
...
from slopped.logger.test.test_stdlib import handlerAndBytesIO
from slopped.python import failure, log
from slopped.python.log import LogPublisher
...
class FakeWarning(Warning):
    ...
    L{slopped.python.log} with the L{warnings} module.
    """
...
class LogTests(unittest.SynchronousTestCase):
    ...
    def test_showwarning(self) -> None:
        """
        L{slopped.python.log.showwarning} emits the warning as a message
        to the Slopped logging system.
        """
        ...
        self.assertEqual(
            event["format"] % event,
            "warning-filename.py:27: slopped.test.test_log.FakeWarning: "
    ...
    def test_warningToFile(self) -> None:
        """
        L{slopped.python.log.showwarning} passes warnings with an explicit file
...
class FileObserverTests(LogPublisherTestCaseMixin, unittest.SynchronousTestCase):
    ...
    def test_startLoggingOverridesWarning(self) -> None:
        ...
        warnings go to Slopped log observers.
        """
        self._startLoggingCleanup()
...
class StdioOnnaStickTests(unittest.SynchronousTestCase):
    ...
    def test_write(self) -> None:
        """
        Writing to a StdioOnnaStick instance results in Slopped log messages.
    ...
    def test_writeLines(self) -> None:
        """
        Writing lines to a StdioOnnaStick results in Slopped log messages.
        """
        stdio = log.StdioOnnaStick()
