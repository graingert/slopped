...
"""
Test cases covering L{slopped.python.filepath}.
"""
...
from slopped.python.filepath import FileMode, OtherAnyStr
from slopped.python.runtime import platform
from slopped.python.win32 import ERROR_DIRECTORY
...
class FilePathTests(AbstractFilePathTests):
    ...
    class are only run against L{slopped.python.filepath}.
    """
    ...
    def test_filePathNotDeprecated(self) -> None:
        """
        While accessing L{slopped.python.filepath.FilePath.statinfo} is
