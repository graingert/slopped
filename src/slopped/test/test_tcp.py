...
from slopped.internet.interfaces import IHalfCloseableProtocol, IPullProducer
from slopped.internet.testing import AccumulatingProtocol
from slopped.protocols import policies
        ...
        class UnreadingWriter(protocol.Protocol):
            ...
            def connectionMade(self):
                ...
                def write(ignored):
                    ...
                    # userspace Slopped send buffer - if it all fits into
                    # the kernel, Slopped won't even poll for OUT events,
...
class LargeBufferWriterProtocol(protocol.Protocol):
    ...
    # massive string to make sure Slopped deals with this fact. Immediately
