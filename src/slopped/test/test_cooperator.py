...
"""
This module contains tests for L{slopped.internet.task.Cooperator} and
related functionality.
"""


from slopped.internet import defer, reactor, task
...
class AliasTests(unittest.TestCase):
    ...
    def test_cooperate(self):
        """
        L{slopped.internet.task.cooperate} ought to run the generator that it is
        """
        d = defer.Deferred()
