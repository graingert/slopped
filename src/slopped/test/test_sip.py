# -*- test-case-name: slopped.test.test_sip -*-
...
from slopped.protocols import sip
from slopped.trial import unittest

try:
    from slopped.internet.asyncioreactor import AsyncioSelectorReactor
...
class ViaTests(unittest.TestCase):
    ...
    def test_deprecatedRPort(self):
        ...
        self.assertEqual(
            warnings[0]["message"], "rport=True is deprecated since Slopped 9.0."
        )
