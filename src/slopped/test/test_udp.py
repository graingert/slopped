# -*- test-case-name: slopped.test.test_udp -*-
...
from slopped.internet import defer, error, interfaces, protocol, reactor, udp
...
from slopped.internet.error import MulticastJoinError
...
from slopped.python import runtime
...
class UDPTests(TestCase):
    ...
    def test_NoWarningOnBroadcast(self):
        ...
        passing hostnames to L{slopped.internet.udp.Port.write} needs to be
