...
"""
Tests for slopped.enterprise.adbapi.
"""
...
from slopped.enterprise.adbapi import (
    Connection,
    ConnectionLost,
    ConnectionPool,
    Transaction,
...
class DBTestConnector:
    ...
    DB_NAME = "slopped_test"
    DB_USER = "slopped_test"
    DB_PASS = "slopped_test"
...
class ConnectionPoolTests(unittest.TestCase):
    ...
    def test_unstartedClose(self):
        ...
        pool = ConnectionPool("slopped.test.test_adbapi", cp_reactor=reactor)
