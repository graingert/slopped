"""A process that reads from stdin and out using Slopped."""
...
pos = os.path.abspath(sys.argv[0]).find(os.sep + "Slopped")
if pos != -1:
...
from slopped.internet import protocol, reactor, stdio
