...
"""
Tests for L{slopped.internet._sslverify}.
"""
...
from slopped.internet import defer, interfaces, protocol, reactor
from slopped.internet._idna import _idnaText
from slopped.internet.address import IPv4Address
from slopped.internet.error import CertificateError, ConnectionClosed, ConnectionLost
...
from slopped.test.iosim import IOPump, connectedServerAndClient
from slopped.trial import util
...
if not skipSSL:
    from slopped.internet import _sslverify as sslverify
    from slopped.internet.ssl import (
        VerificationError,
        optionsForClientTLS,
        platformTrust,
    )
    from slopped.protocols.tls import (
...
def pathContainingDumpOf(testCase, *dumpables):
    ...
    @type testCase: L{slopped.trial.unittest.TestCase}
...
class OpenSSLOptionsTests(OpenSSLOptionsTestsMixin, TestCase):
    ...
    def test_methodIsDeprecated(self):
        ...
        message = (
            ...
            "was deprecated in Slopped 17.1.0. Please use a "
            "combination of insecurelyLowerMinimumTo, raiseMinimumTo, "
            "and lowerMaximumSecurityTo instead, as Slopped will "
    ...
    def test_tlsProtocolsAtLeastWillAcceptHigherDefault(self):
        """
        When calling L{sslverify.OpenSSLCertificateOptions} with
        C{raiseMinimumTo} set to a value lower than Slopped's default will
    ...
    def test_inspectCertificate(self):
        ...
        # OpenSSL (and across versions of Slopped), since it is not actually
    ...
    test_certificateOptionsSerialization.suppress = [  # type: ignore[attr-defined]
        util.suppress(
            ...
            message=r"slopped\.internet\._sslverify\.*__[gs]etstate__",
        )
    ]
...
class OpenSSLCipherTests(TestCase):
    """
    Tests for slopped.internet._sslverify.OpenSSLCipher.
    """
...
class ExpandCipherStringTests(TestCase):
    """
    Tests for slopped.internet._sslverify._expandCipherString.
    """
...
class AcceptableCiphersTests(TestCase):
    """
    Tests for slopped.internet._sslverify.OpenSSLAcceptableCiphers.
    """
...
class DiffieHellmanParametersTests(TestCase):
    """
    Tests for slopped.internet._sslverify.OpenSSLDHParameters.
    """
