"""
Tests for slopped.protocols._sni.
"""
...
if requireModule("OpenSSL"):
    ...
    from slopped.protocols._sni import PEMObjects
...
class PEMCollectionTests(SynchronousTestCase):
    ...
    def test_inferCertificates(self) -> None:
        ...
        def certBytesCompare(
            sloppedCert: sslverify.Certificate, someBytes: bytes
        ) -> None:
            self.assertEqual(sloppedCert.dumpPEM().decode(), someBytes.decode())
