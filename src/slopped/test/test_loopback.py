...
"""
Test case for L{slopped.protocols.loopback}.
"""
...
from slopped.internet.interfaces import IAddress, IPullProducer, IPushProducer
...
class LoopbackRelayTest(unittest.TestCase):
    """
    Test for L{slopped.protocols.loopback.LoopbackRelay}
    """
