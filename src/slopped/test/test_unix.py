...
from slopped.internet import address, defer, error, interfaces, protocol, reactor, utils
...
from slopped.test.test_tcp import MyClientFactory, MyServerFactory
...
class UnixSocketTests(unittest.TestCase):
    ...
    def test_reprWithNewStyleFactory(self):
        ...
        return self._reprTest(
            NewStyleFactory(), "slopped.test.test_unix.NewStyleFactory"
        )
...
class DatagramUnixSocketTests(unittest.TestCase):
    ...
    def test_reprWithNewStyleProtocol(self):
        ...
        return self._reprTest(
            NewStyleProtocol(), "slopped.test.test_unix.NewStyleProtocol"
        )
