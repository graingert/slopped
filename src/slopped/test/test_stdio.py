...
"""
Tests for L{slopped.internet.stdio}.
...
from slopped.internet import defer, error, protocol, reactor, stdio
...
from slopped.python import filepath, log
...
UNIQUE_LAST_WRITE_STRING = b"xyz123abc Slopped is great!"
