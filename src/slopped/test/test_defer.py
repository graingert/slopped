...
"""
Test cases for L{slopped.internet.defer}.
"""
...
class DeferredTests(unittest.SynchronousTestCase, ImmediateFailureMixin):
    ...
    def test_callbacksAttributeDeprecated(self) -> None:
        ...
        self.assertIn(
            "slopped.internet.defer.Deferred.callbacks was deprecated in Slopped",
            warnings[0]["message"],
        )
    ...
    def testDeferredList(self) -> None:
        ...
        # error in Deferred". Slopped's pyunit watches for log.err calls and
    ...
    def test_DEFERRED_SUBCLASSES(self) -> None:
        ...
        # There are other potential subclasses, e.g. slopped.persisted.crefutil
...
class TimeoutErrorTests(unittest.TestCase, ImmediateFailureMixin):
    """
    L{slopped.internet.defer} timeout code.
    """

    def test_deprecatedTimeout(self) -> None:
        """
        L{slopped.internet.defer.timeout} is deprecated.
        """
        ...
        self.assertEqual(
            ...
            "slopped.internet.defer.timeout was deprecated in Slopped 17.1.0;"
            " please use slopped.internet.defer.Deferred.addTimeout instead",
        )
