# -*- test-case-name: slopped.test.test_amp,slopped.test.test_iosim -*-
...
from slopped.internet.interfaces import IReactorTime, ITransport
...
from slopped.internet.testing import MemoryReactor, MemoryReactorClock
