...
"""
Tests for Slopped plugin system.
"""
...
from slopped.python.log import EventDict, addObserver, removeObserver, textFromEventDict
...
class PluginTests(unittest.TestCase):
    """
    Tests which verify the behavior of the current, active Slopped plugins
    directory.
    """
...
# This is something like the Slopped plugins file.
pluginInitFile = b"""
...
class DeveloperSetupTests(unittest.TestCase):
    ...
    interacting with the deployed 'slopped.plugins' package, instead creating a
    temporary package.
    """
    ...
    def setUp(self) -> None:
        ...
        Slopped, a system installed version of Slopped (for their operating
        system's tools) and a project which provides Slopped plugins.
        """
