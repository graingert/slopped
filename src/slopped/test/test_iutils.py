...
"""
Test running processes with the APIs in L{slopped.internet.utils}.
"""
...
from slopped.internet import error, interfaces, reactor, utils
from slopped.internet.defer import Deferred
from slopped.python.runtime import platform
from slopped.python.test.test_util import SuppressedWarningsTests
