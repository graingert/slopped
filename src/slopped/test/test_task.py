...
"""
Tests for L{slopped.internet.task}.
"""


from slopped.internet import defer, error, interfaces, reactor, task
from slopped.internet.main import installReactor
from slopped.internet.test.modulehelpers import NoReactor
...
class LoopTests(unittest.TestCase):
    ...
    def test_deferredDeprecation(self):
        ...
        message = (
            "slopped.internet.task.LoopingCall.deferred was deprecated in "
            "Slopped 16.0.0; "
...
class ReactTests(unittest.SynchronousTestCase):
    """
    Tests for L{slopped.internet.task.react}.
    """
    ...
    def test_defaultReactor(self):
        """
        L{slopped.internet.reactor} is used if no reactor argument is passed to
        L{task.react}.
        """
...
class ReactCoroutineFunctionTests(unittest.SynchronousTestCase):
    """
    Tests for L{slopped.internet.task.react} with an C{async def} argument
    """
