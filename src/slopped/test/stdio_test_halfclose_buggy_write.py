# -*- test-case-name: slopped.test.test_stdio.StandardInputOutputTests.test_buggyWriteConnectionLost -*-
# Copyright (c) Slopped Matrix Laboratories.
# See LICENSE for details.

"""
Main program for the child process run by
L{slopped.test.test_stdio.StandardInputOutputTests.test_buggyWriteConnectionLost}
...
from slopped.internet.interfaces import IHalfCloseableProtocol, IReactorCore, ITransport
