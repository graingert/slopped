...
"""
Tests for L{slopped.python.threadpool}
"""
...
from slopped._threads import Team, createMemoryWorker
from slopped.python import context, failure, threadable, threadpool
...
class MemoryPool(threadpool.ThreadPool):
    ...
    def __init__(self, coordinator, failTest, newWorker, *args, **kwargs):
        ...
        @type coordinator: L{slopped._threads.IExclusiveWorker}
        ...
        @param newWorker: a 0-argument callable that produces a new
            L{slopped._threads.IWorker} provider on each invocation.
        @type newWorker: 0-argument callable returning
            L{slopped._threads.IWorker}.
        """
    ...
    def _pool(self, currentLimit, threadFactory):
        ...
        def respectLimit():
            ...
            # slopped.threads._pool, which is unfortunately bound up
...
class PoolHelper:
    ...
    use threads, by using the internal interfaces in L{slopped._threads}.
