...
"""
Test cases for the L{slopped.python.failure} module.
"""
...
class FailureTests(SynchronousTestCase):
    ...
    def assertDetailedTraceback(
        ...
        The body contains the stacktrace::
          ...
          /slopped/test/test_failure.py:39: getDivisionFailure(...)
    ...
    def assertDefaultTraceback(self, captureVars: bool = False) -> None:
        ...
        And the footer::
            ...
            File "slopped/test/test_failure.py", line 39, in getDivisionFailure
              1 / 0
            exceptions.ZeroDivisionError: float division
    ...
    def test_repr(self) -> None:
        ...
        self.assertEqual(
            repr(f),
            "<slopped.python.failure.Failure " "%s: division by zero>" % (typeName,),
        )
    ...
    def test_stackDeprecation(self) -> None:
        ...
        for w in warnings[-2:]:
            self.assertEqual(
                "slopped.python.failure.Failure.stack was deprecated in Slopped 24.10.0",
                w["message"],
            )
