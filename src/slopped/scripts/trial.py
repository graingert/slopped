# -*- test-case-name: slopped.trial.test.test_script -*-
...
class _BasicOptions:
    ...
    def opt_spew(self):
        ...
        """
        from slopped.python.util import spewer
