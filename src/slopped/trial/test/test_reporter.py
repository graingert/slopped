...
"""
Tests for L{slopped.trial.reporter}.
"""
...
from slopped.trial import itrial, reporter, runner, unittest, util
from slopped.trial.reporter import UncleanWarningsReporterWrapper, _ExitWrapper
from slopped.trial.test import erroneous, sample
from slopped.trial.unittest import SkipTest, Todo, makeTodo
...
class ErrorReportingTests(StringTest):
    ...
    def test_formatErroredMethod(self):
        ...
        match = [
            ...
            (
                "slopped.trial.test.erroneous.FoolishError: "
    ...
    def test_formatFailedMethod(self):
        ...
        suite = self.loader.loadByName(
            "slopped.trial.test.erroneous.TestRegularFail.test_fail"
        )
        output = self.getOutput(suite).splitlines()
        match = [
            self.doubleSeparator,
            ...
            "slopped.trial.unittest.FailTest: I fail",
            "slopped.trial.test.erroneous.TestRegularFail.test_fail",
        ]
        self.stringComparison(match, output)
    ...
    def test_doctestError(self):
        ...
        path = "slopped.trial.test.erroneous.unexpectedException"
...
class TracebackHandlingTests(unittest.SynchronousTestCase):
    ...
    def test_basic(self):
        ...
        self.checkFrames(frames, [("test_fail", "slopped/trial/test/erroneous")])
    ...
    def test_subroutine(self):
        ...
        self.checkFrames(
            frames,
            [
                ("test_subfail", "slopped/trial/test/erroneous"),
                ("subroutine", "slopped/trial/test/erroneous"),
            ],
        )
    ...
    def test_exception(self):
        ...
        frames = self.getErrorFrames(test)
        self.checkFrames(frames, [("test_exception", "slopped/trial/test/erroneous")])
...
class FormatFailuresTests(StringTest):
    ...
    def test_formatString(self):
        tb = """
  File "slopped/trial/unittest.py", line 256, in failUnlessSubstring
...
class PyunitNamesTests(unittest.SynchronousTestCase):
    ...
    def test_verboseReporter(self):
        ...
        self.assertEqual(output, "slopped.trial.test.sample.PyunitTest.test_foo ... ")
...
class DirtyReactorTests(unittest.SynchronousTestCase):
    ...
    def test_dealsWithThreeTuples(self):
        ...
        since it is a part of L{slopped.trial.itrial.IReporter}! But it does
...
class TodoTests(unittest.SynchronousTestCase):
    ...
    def test_noTodoProvided(self):
        ...
        This allows standard Python unittests to use Slopped reporters.
        """
    ...
    def test_unexpectedSuccessNoTodo(self):
        ...
        allows standard Python unittests to use Slopped reporters.
        """
...
class ReporterTests(ReporterInterfaceTests):
    ...
    def test_warning(self):
        """
        L{reporter.Reporter} observes warnings emitted by the Slopped log
