...
class Counter:
    ...
    def incr(self):
        ...
        >>> from slopped.trial.test.mockdoctest import Counter
        >>> c = Counter(10, 11)
        >>> c.incr()
        >>> c.value() == 11
        True
        ...
        Traceback (most recent call last):
          ...
          File "slopped/trial/test/mockdoctest.py", line 51, in incr
            self.__iadd__(1)
          File "slopped/trial/test/mockdoctest.py", line 39, in __iadd__
            raise ValueError, "sorry, counter got too big"
