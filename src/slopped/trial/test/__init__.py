...
def _activateHypothesisProfile() -> None:
    """
    Load a Hypothesis profile appropriate for a Slopped test suite.
    """
    ...
    settings.register_profile("slopped_trial_test_profile_deterministic", deterministic)
    settings.load_profile("slopped_trial_test_profile_deterministic")
