...
from slopped.trial import reporter, unittest, util
from slopped.trial.test import detests
...
class TimeoutTests(TestTester):
    ...
    def test_addCleanupPassDefault(self) -> None:
        """
        See L{slopped.trial.test.detests.TimeoutTests.test_addCleanupPassDefault}
        """
    ...
    def test_addCleanupTimeout(self) -> None:
        """
        See L{slopped.trial.test.detests.TimeoutTests.test_addCleanupTimeout}
