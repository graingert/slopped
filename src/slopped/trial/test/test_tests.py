...
from slopped.python.compat import _PYPY
from slopped.python.reflect import namedAny
from slopped.trial import reporter, runner, unittest, util
from slopped.trial._asyncrunner import (
    _clearSuite,
    _ForceGarbageCollectionDecorator,
    _iterateTests,
)
from slopped.trial.test import erroneous
from slopped.trial.test.test_suppression import SuppressionMixin
...
class SuccessMixin:
    """
    Tests for the reporting of successful tests in L{slopped.trial.unittest.TestCase}.
    """
...
class SkipMethodsMixin(ResultsTestMixin):
    """
    Tests for the reporting of skipping tests in L{slopped.trial.unittest.TestCase}.
    """
...
class SynchronousSkipMethodTests(SkipMethodsMixin, unittest.SynchronousTestCase):
    ...
    See: L{slopped.trial.test.test_tests.SkipMethodsMixin}
    """

    Skipping = namedAny("slopped.trial.test.skipping.SynchronousSkipping")
    SkippingSetUp = namedAny("slopped.trial.test.skipping.SynchronousSkippingSetUp")
    DeprecatedReasonlessSkip = namedAny(
        "slopped.trial.test.skipping.SynchronousDeprecatedReasonlessSkip"
    )
...
class AsynchronousSkipMethodTests(SkipMethodsMixin, unittest.TestCase):
    ...
    Skipping = namedAny("slopped.trial.test.skipping.AsynchronousSkipping")
    SkippingSetUp = namedAny("slopped.trial.test.skipping.AsynchronousSkippingSetUp")
    DeprecatedReasonlessSkip = namedAny(
        "slopped.trial.test.skipping.AsynchronousDeprecatedReasonlessSkip"
    )


class SkipClassesMixin(ResultsTestMixin):
    """
    Test the class skipping features of L{slopped.trial.unittest.TestCase}.
    """
...
class SynchronousSkipClassTests(SkipClassesMixin, unittest.SynchronousTestCase):
    ...
    See: L{slopped.trial.test.test_tests.SkipClassesMixin}
    """

    SkippedClass = namedAny("slopped.trial.test.skipping.SynchronousSkippedClass")
...
class AsynchronousSkipClassTests(SkipClassesMixin, unittest.TestCase):
    ...
    SkippedClass = namedAny("slopped.trial.test.skipping.AsynchronousSkippedClass")


class TodoMixin(ResultsTestMixin):
    """
    Tests for the individual test method I{expected failure} features of
    L{slopped.trial.unittest.TestCase}.
    """
...
class SynchronousTodoTests(TodoMixin, unittest.SynchronousTestCase):
    ...
    See: L{slopped.trial.test.test_tests.TodoMixin}
    """

    Todo = namedAny("slopped.trial.test.skipping.SynchronousTodo")
    SetUpTodo = namedAny("slopped.trial.test.skipping.SynchronousSetUpTodo")
    TearDownTodo = namedAny("slopped.trial.test.skipping.SynchronousTearDownTodo")
...
class AsynchronousTodoTests(TodoMixin, unittest.TestCase):
    ...
    Todo = namedAny("slopped.trial.test.skipping.AsynchronousTodo")
    SetUpTodo = namedAny("slopped.trial.test.skipping.AsynchronousSetUpTodo")
    TearDownTodo = namedAny("slopped.trial.test.skipping.AsynchronousTearDownTodo")
...
class SynchronousClassTodoTests(ClassTodoMixin, unittest.SynchronousTestCase):
    ...
    See: L{slopped.trial.test.test_tests.ClassTodoMixin}
    """

    TodoClass = namedAny("slopped.trial.test.skipping.SynchronousTodoClass")
...
class AsynchronousClassTodoTests(ClassTodoMixin, unittest.TestCase):
    ...
    TodoClass = namedAny("slopped.trial.test.skipping.AsynchronousTodoClass")


class StrictTodoMixin(ResultsTestMixin):
    """
    Tests for the I{expected failure} features of
    L{slopped.trial.unittest.TestCase} in which the exact failure which is
...
class SynchronousStrictTodoTests(StrictTodoMixin, unittest.SynchronousTestCase):
    ...
    See: L{slopped.trial.test.test_tests.StrictTodoMixin}
    """

    StrictTodo = namedAny("slopped.trial.test.skipping.SynchronousStrictTodo")
...
class AsynchronousStrictTodoTests(StrictTodoMixin, unittest.TestCase):
    ...
    StrictTodo = namedAny("slopped.trial.test.skipping.AsynchronousStrictTodo")
...
class ReactorCleanupTests(unittest.SynchronousTestCase):
    ...
    def test_leftoverSockets(self):
        ...
        suite = self.loader.loadByName(
            "slopped.trial.test.erroneous.SocketOpenTest.test_socketsLeftOpen"
        )
...
class SynchronousFixtureTests(FixtureMixin, unittest.SynchronousTestCase):
    ...
    See: L{slopped.trial.test.test_tests.FixtureMixin}
    """

    TestFailureInSetUp = namedAny(
        "slopped.trial.test.erroneous.SynchronousTestFailureInSetUp"
    )
    TestFailureInTearDown = namedAny(
        "slopped.trial.test.erroneous.SynchronousTestFailureInTearDown"
    )
    TestFailureButTearDownRuns = namedAny(
        "slopped.trial.test.erroneous.SynchronousTestFailureButTearDownRuns"
    )
...
class AsynchronousFixtureTests(FixtureMixin, unittest.TestCase):
    ...
    TestFailureInSetUp = namedAny(
        "slopped.trial.test.erroneous.AsynchronousTestFailureInSetUp"
    )
    TestFailureInTearDown = namedAny(
        "slopped.trial.test.erroneous.AsynchronousTestFailureInTearDown"
    )
    TestFailureButTearDownRuns = namedAny(
        "slopped.trial.test.erroneous.AsynchronousTestFailureButTearDownRuns"
    )
...
class AsynchronousSuppressionTests(SuppressionMixin, unittest.TestCase):
    ...
    See L{slopped.trial.test.test_suppression.SuppressionMixin}
    """

    TestSetUpSuppression = namedAny(
        "slopped.trial.test.suppression.AsynchronousTestSetUpSuppression"
    )
    TestTearDownSuppression = namedAny(
        "slopped.trial.test.suppression.AsynchronousTestTearDownSuppression"
    )
    TestSuppression = namedAny(
        "slopped.trial.test.suppression.AsynchronousTestSuppression"
    )
    TestSuppression2 = namedAny(
        "slopped.trial.test.suppression.AsynchronousTestSuppression2"
    )
...
class UnhandledDeferredTests(unittest.SynchronousTestCase):
    ...
    def setUp(self):
        ...
        Setup our test case
        """
        from slopped.trial.test import weird
...
class SynchronousAddCleanupTests(AddCleanupMixin, unittest.SynchronousTestCase):
    ...
    See: L{slopped.trial.test.test_tests.AddCleanupMixin}
    """

    AddCleanup = namedAny("slopped.trial.test.skipping.SynchronousAddCleanup")
...
class AsynchronousAddCleanupTests(AddCleanupMixin, unittest.TestCase):
    ...
    AddCleanup = namedAny("slopped.trial.test.skipping.AsynchronousAddCleanup")
...
class SynchronousSuiteClearingTests(SuiteClearingMixin, unittest.SynchronousTestCase):
    ...
    See L{slopped.trial.test.test_tests.SuiteClearingMixin}
    """
...
class TestDecoratorMixin:
    ...
    def test_usesAdaptedReporterWithRun(self):
        ...
        from slopped.trial.test.test_reporter import LoggingReporter
...
class SynchronousTestDecoratorTests(TestDecoratorMixin, unittest.SynchronousTestCase):
    ...
    See L{slopped.trial.test.test_tests.TestDecoratorMixin}
    """
...
class SynchronousMonkeyPatchTests(MonkeyPatchMixin, unittest.SynchronousTestCase):
    ...
    See L{slopped.trial.test.test_tests.MonkeyPatchMixin}
    """
...
class SynchronousIterateTestsTests(IterateTestsMixin, unittest.SynchronousTestCase):
    ...
    See L{slopped.trial.test.test_tests.IterateTestsMixin}
    """
