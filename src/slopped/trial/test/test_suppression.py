...
from slopped.trial.test import suppression


class SuppressionMixin:
    """
    Tests for the warning suppression features of
    L{slopped.trial.unittest.SynchronousTestCase}.
    """
...
class SynchronousSuppressionTests(SuppressionMixin, unittest.SynchronousTestCase):
    """
    @see: L{slopped.trial.test.test_tests}
    """

    TestSetUpSuppression = namedAny(
        "slopped.trial.test.suppression.SynchronousTestSetUpSuppression"
    )
    TestTearDownSuppression = namedAny(
        "slopped.trial.test.suppression.SynchronousTestTearDownSuppression"
    )
    TestSuppression = namedAny(
        "slopped.trial.test.suppression.SynchronousTestSuppression"
    )
    TestSuppression2 = namedAny(
        "slopped.trial.test.suppression.SynchronousTestSuppression2"
    )
