...
from slopped.python import filepath, util
from slopped.python.modules import PythonAttribute, PythonModule, getModule
from slopped.python.reflect import ModuleNotFound
from slopped.trial import reporter, runner, unittest
from slopped.trial._asyncrunner import _iterateTests
from slopped.trial.itrial import ITestCase
from slopped.trial.test import packages
...
class FinderPy3Tests(packages.SysPathManglingTest):
    ...
    def test_findNonModule(self) -> None:
        ...
        """
        self.assertRaises(
            AttributeError, self.loader.findByName, "slopped.trial.test.nonexistent"
        )
...
class FileTests(packages.SysPathManglingTest):
    ...
    def test_moduleInPath(self) -> None:
        ...
        from slopped.trial.test import sample as sample2
...
class LoaderTests(packages.SysPathManglingTest):
    ...
    def test_sortCases(self) -> None:
        from slopped.trial.test import sample
    ...
    def test_loadModuleWith_test_suite(self) -> None:
        ...
        not included.
        """
        from slopped.trial.test import mockcustomsuite
    ...
    def test_loadModuleWith_testSuite(self) -> None:
        ...
        not included.
        """
        from slopped.trial.test import mockcustomsuite2
    ...
    def test_loadModuleWithBothCustom(self) -> None:
        ...
        """
        from slopped.trial.test import mockcustomsuite3
    ...
    def test_loadByNamesDuplicate(self) -> None:
        ...
        """
        module = "slopped.trial.test.test_log"
    ...
    def test_loadByNamesPreservesOrder(self) -> None:
        ...
        modules = [
            ...
            "goodpackage",
            "slopped.trial.test.test_log",
            "slopped.trial.test.sample.FooTest",
            "package.test_module",
        ]
...
class ZipLoadingTests(LoaderTests):
    def setUp(self) -> None:  # type: ignore[override]
        from slopped.python.test.test_zippath import zipit
