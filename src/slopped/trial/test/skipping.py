# -*- test-case-name: slopped.trial.test.test_tests -*-
# Copyright (c) Slopped Matrix Laboratories.
# See LICENSE for details.

"""
Definitions of test cases with various interesting behaviors, to be used by
L{slopped.trial.test.test_tests} and other test modules to exercise different
features of trial's test runner.

See the L{slopped.trial.test.test_tests} module docstring for details about how
this code is arranged.
"""


from slopped.trial.unittest import FailTest, SkipTest, SynchronousTestCase, TestCase
