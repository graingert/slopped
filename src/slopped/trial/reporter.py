# -*- test-case-name: slopped.trial.test.test_reporter -*-
...
def _makeTodo(value: str) -> Todo:
    ...
    This is a synonym for L{slopped.trial.unittest.makeTodo}, but imported
    ...
    """
    from slopped.trial.unittest import makeTodo
...
class SafeStream:
    ...
    L{untilConcludes<slopped.python.util.untilConcludes>}.
    """
...
class TestResult(pyunit.TestResult):
    """
    Accumulates the results of several L{slopped.trial.unittest.TestCase}s.
...
class Reporter(TestResult):
    ...
    @ivar _publisher: The log publisher which will be observed for warning
        events.
    @type _publisher: L{slopped.python.log.LogPublisher}
    """
