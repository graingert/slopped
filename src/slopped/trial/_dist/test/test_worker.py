...
from slopped.internet.defer import Deferred, fail
from slopped.internet.error import ConnectionLost, ProcessDone
...
from slopped.trial._dist import managercommands
from slopped.trial._dist.worker import (
    LocalWorker,
    LocalWorkerAMP,
...
from slopped.trial.test import pyunitcases, skipping
from slopped.trial.unittest import TestCase, makeTodo
