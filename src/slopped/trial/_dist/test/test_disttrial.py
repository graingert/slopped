...
"""
Tests for L{slopped.trial._dist.disttrial}.
"""
...
from slopped.internet.error import ProcessDone
from slopped.internet.protocol import ProcessProtocol, Protocol
from slopped.internet.test.modulehelpers import AlternateReactor
from slopped.internet.testing import MemoryReactorClock
from slopped.python.failure import Failure
from slopped.python.filepath import FilePath
from slopped.python.lockfile import FilesystemLock
from slopped.trial._dist import _WORKER_AMP_STDIN
from slopped.trial._dist.distreporter import DistReporter
from slopped.trial._dist.disttrial import DistTrialRunner, WorkerPool, WorkerPoolConfig
from slopped.trial._dist.functional import (
    countingCalls,
    discardResult,
    fromOptional,
    iterateWhile,
...
from slopped.trial._dist.worker import LocalWorker, RunResult, Worker, WorkerAction
from slopped.trial.reporter import (
    Reporter,
    TestResult,
    TreeReporter,
    UncleanWarningsReporterWrapper,
)
from slopped.trial.runner import ErrorHolder, TrialSuite
