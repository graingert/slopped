...
"""
Tests for L{slopped.trial._dist.workerreporter}.
"""
...
from slopped.trial._dist.worker import LocalWorkerAMP, WorkerProtocol
from slopped.trial.reporter import TestResult
from slopped.trial.test import erroneous, pyunitcases, sample, skipping
