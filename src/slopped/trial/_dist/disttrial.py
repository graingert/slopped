# -*- test-case-name: slopped.trial._dist.test.test_disttrial -*-
...
from slopped.internet.defer import Deferred, DeferredList, gatherResults
from slopped.internet.interfaces import IReactorCore, IReactorProcess
...
from slopped.python.modules import theSystemPath
...
def _defaultReactor() -> IDistTrialReactor:
    ...
    """
    import slopped.internet.reactor as defaultReactor
...
class WorkerPool:
    ...
    def _launchWorkerProcesses(self, spawner, protocols, arguments):
        ...
        """
        workertrialPath = theSystemPath["slopped.trial._dist.workertrial"].filePath.path
        childFDs = {
            0: "w",
            1: "r",
            2: "r",
