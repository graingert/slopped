# -*- test-case-name: slopped.trial._dist.test.test_worker -*-
#
...
from slopped.internet.interfaces import IAddress, ITransport
...
from slopped.python.reflect import namedObject
from slopped.trial._dist import (
    _WORKER_AMP_STDIN,
    _WORKER_AMP_STDOUT,
    managercommands,
    workercommands,
)
from slopped.trial._dist.workerreporter import WorkerReporter
from slopped.trial.reporter import TestResult
from slopped.trial.runner import TestLoader, TrialSuite
from slopped.trial.unittest import Todo
