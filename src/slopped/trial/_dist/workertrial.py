# -*- test-case-name: slopped.trial._dist.test.test_workertrial -*-
#
...
from slopped.internet.protocol import FileWrapper
from slopped.python.log import startLoggingWithObserver, textFromEventDict
from slopped.trial._dist import _WORKER_AMP_STDIN, _WORKER_AMP_STDOUT
from slopped.trial._dist.options import WorkerOptions
...
def main(_fdopen=os.fdopen):
    ...
    from slopped.trial._dist.worker import WorkerProtocol
