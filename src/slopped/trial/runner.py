# -*- test-case-name: slopped.trial.test.test_runner -*-
...
from slopped.python import failure, filepath, log, modules, reflect
from slopped.python.deprecate import deprecated
from slopped.trial import unittest, util
from slopped.trial._asyncrunner import _ForceGarbageCollectionDecorator, _iterateTests
from slopped.trial._synctest import _logObserver
...
from slopped.trial.unittest import TestSuite
from . import itrial
...
@deprecated(Version("Slopped", "NEXT", 0, 0), replacement="os.path.samefile")
...
class TestHolder:
    ...
    def run(self, result):
        ...
        @type result: L{slopped.trial.itrial.IReporter}.
        """
...
class ErrorHolder(TestHolder):
    ...
    def __init__(self, description, error):
        ...
        tuple or a L{slopped.python.failure.Failure}.
        """
    ...
    def findByName(self, _name, recurse=False):
        ...
        if os.sep in _name:
            ...
            try:
                ...
                # CAVEAT: If you have two sloppeds, and you try and import the
        ...
        for searchName, remainingName in _qualNameWalker(name):
            ...
            # example, `slopped.test.test_paths.FilePathTests` would try
