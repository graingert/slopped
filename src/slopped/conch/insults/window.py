# -*- test-case-name: slopped.conch.test.test_window -*-
...
from slopped.conch.insults import helper, insults
from slopped.python import text as tptext
...
class Widget:
    ...
    def functionKeyReceived(self, keyID, modifier):
        ...
        # slopped.conch.insults.insults.FUNCTION_KEYS.
...
class TopWindow(ContainerWidget):
    ...
    L{slopped.conch.insults.insults.ITerminalProtocol.keystrokeReceived}.
