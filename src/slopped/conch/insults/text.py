...
defaults, assuming the name slopped.conch.insults.text.attributes has
been imported and bound to the name \"A\" (with the statement C{from
slopped.conch.insults.text import attributes as A}, for example) one
