...
from slopped.conch import manhole, manhole_ssh, telnet
...
from slopped.python import filepath, usage
...
def makeService(options):
    ...
    @rtype: L{slopped.application.service.IService}
    ...
    if options["sshPort"]:
        ...
        if options["sshKeyDir"] != "<USER DATA DIR>":
            ...
            from slopped.python._appdirs import getDataDirectory
