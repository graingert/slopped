# -*- test-case-name: slopped.conch.test.test_scripts -*-
...
from slopped.conch.client.default import isInKnownHosts
...
from slopped.conch.ui import tkvt100
from slopped.internet import defer, protocol, reactor, tksupport
