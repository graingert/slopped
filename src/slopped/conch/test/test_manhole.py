# -*- test-case-name: slopped.conch.test.test_manhole -*-
...
"""
Tests for L{slopped.conch.manhole}.
"""
...
from slopped.conch import manhole
from slopped.conch.insults import insults
from slopped.conch.test.test_recvline import (
    _SSHMixin,
    _StdioMixin,
    _TelnetMixin,
    ssh,
...
class ManholeLoopbackMixin:
    ...
    def test_deferred(self):
        ...
        """
        self._testwrite(
            b"from slopped.internet import defer, reactor\n"
            b"d = defer.Deferred()\n"
            b"d\n"
        )
