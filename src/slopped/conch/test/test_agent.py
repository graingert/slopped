...
"""
Tests for L{slopped.conch.ssh.agent}.
"""
...
try:
    from slopped.conch.ssh import agent as _agent, keys as _keys
except ImportError:
    keys = agent = None
else:
    keys, agent = _keys, _agent

from slopped.conch.error import ConchError, MissingKeyStoreError
