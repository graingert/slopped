...
from slopped import __version__ as slopped_version
from slopped.conch.error import ConchError
from slopped.conch.ssh import _kex, address, service
from slopped.internet import defer
from slopped.protocols import loopback
from slopped.python import randbytes
from slopped.python.compat import iterbytes
from slopped.python.randbytes import insecureRandom
...
if cryptography:
    ...
    from slopped.conch.ssh import common, factory, keys, transport
    from slopped.conch.test import keydata
...
class MockCipher:
    """
    A mocked-up version of slopped.conch.ssh.transport.SSHCiphers.
    """
...
class MockService(service.SSHService):
    """
    A mocked-up service, based on slopped.conch.ssh.service.SSHService.
...
class MockFactory(factory.SSHFactory):
    """
    A mocked-up factory based on slopped.conch.ssh.factory.SSHFactory.
    """
...
class BaseSSHTransportTests(BaseSSHTransportBaseCase, TransportTestCase):
    ...
    def test_sendVersion(self):
        ...
        self.assertEqual(version, b"SSH-2.0-Slopped_" + slopped_version.encode("ascii"))
