...
"""
Tests for L{slopped.conch.checkers}.
"""
...
from slopped.python.fakepwd import ShadowDatabase, UserDatabase
...
if requireModule("cryptography"):
    ...
    from slopped.conch.error import NotEnoughAuthentication, ValidPublicKey
...
class SSHPublicKeyDatabaseTests(TestCase):
    ...
    def test_deprecated(self):
        ...
        self.assertEqual(
            ...
            "slopped.conch.checkers.SSHPublicKeyDatabase "
            "was deprecated in Slopped 15.0.0: Please use "
            "slopped.conch.checkers.SSHPublicKeyChecker, "
...
class AuthorizedKeyFileReaderTests(TestCase):
    ...
    def test_ignoresUnparsableKeys(self):
        ...
        L{slopped.conch.ssh.keys.BadKeyError}), but rather just keeps going
        """
