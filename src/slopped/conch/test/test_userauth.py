...
from slopped.conch.error import ConchError, ValidPublicKey
from slopped.cred.checkers import ICredentialsChecker
from slopped.cred.credentials import IAnonymous, ISSHPrivateKey, IUsernamePassword
...
if requireModule("cryptography"):
    from slopped.conch.checkers import SSHProtocolChecker
    from slopped.conch.ssh import keys, transport, userauth
    from slopped.conch.ssh.common import MP, NS
    from slopped.conch.test import keydata
    from slopped.conch.test.sk_dummy import SK_FLAGS_USER_PRESENCE, DummySK, SKAlgorithm
else:
