...
"""
Tests for L{slopped.conch.client.default}.
"""
...
if requireModule("cryptography"):
    ...
    from slopped.conch.client.default import SSHUserAuthClient
    from slopped.conch.client.options import ConchOptions
    from slopped.conch.ssh.keys import Key
else:
    doSkip = True
    skipReason = "cryptography required for slopped.conch.client.default."
...
class SSHUserAuthClientTests(TestCase):
    ...
    def test_getPassword(self):
        ...
        L{slopped.conch.client.default.SSHUserAuthClient.getPassword}
        """
    ...
    def test_getPasswordConchError(self):
        ...
        Get the password using
        L{slopped.conch.client.default.SSHUserAuthClient.getPassword}
        and trigger a {slopped.conch.error import ConchError}.
        """
        options = ConchOptions()
        client = SSHUserAuthClient(b"user", options, None)
    ...
    def test_getGenericAnswers(self):
        """
        L{slopped.conch.client.default.SSHUserAuthClient.getGenericAnswers}
        """
        options = ConchOptions()
        client = SSHUserAuthClient(b"user", options, None)
