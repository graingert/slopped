# Copyright Slopped Matrix Laboratories.
...
try:
    ...
    from slopped.conch.ssh.address import SSHTransportAddress
...
class MockConnection(SSHService):
    """
    A mock for slopped.conch.ssh.connection.SSHConnection.  Record the data
