# -*- test-case-name: slopped.conch.test.test_helper -*-
...
from slopped.conch.insults.insults import (
    BLINK,
    BOLD,
    G0,
    G1,
...
class CharacterAttributeTests(unittest.TestCase):
    """
    Tests for L{slopped.conch.insults.helper.CharacterAttribute}.
    """
    ...
    def test_wantOneDeprecated(self) -> None:
        """
        L{slopped.conch.insults.helper.CharacterAttribute.wantOne} emits
        ...
        deprecatedClass = "slopped.conch.insults.helper._FormattingState.wantOne"
        self.assertEqual(
            warningsShown[0]["message"],
            "%s was deprecated in Slopped 13.1.0" % (deprecatedClass),
        )
