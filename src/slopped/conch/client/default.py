# -*- test-case-name: slopped.conch.test.test_knownhosts,slopped.conch.test.test_default -*-
...
interact with a known_hosts database, use L{slopped.conch.client.knownhosts}.
"""
...
def verifyHostKey(
    ...
    if TYPE_CHECKING:
        ...
        from slopped.conch.client.direct import SSHClientFactory
...
def getHostKeyAlgorithms(host, options):
    ...
    @type options: L{slopped.conch.client.options.ConchOptions}
