# -*- test-case-name: slopped.conch.test.test_knownhosts -*-
...
from slopped.conch.ssh.keys import BadKeyError, FingerprintFormats, Key
...
class _BaseEntry:
    ...
    @type publicKey: L{slopped.conch.ssh.keys.Key}
