# -*- test-case-name: slopped.conch.test.test_transport -*-
...
from slopped.conch.ssh import _kex, address, keys
from slopped.conch.ssh.common import MP, NS, ffs, getMP, getNS
from slopped.conch.ssh.service import SSHService
...
class SSHTransportBase(protocol.Protocol):
    ...
    version = b"Slopped_" + slopped_version.encode("ascii")
    comment = b""
    ourVersionString = (
    ...
    # Set by slopped.conch.ssh.userauth.SSHUserAuthServer._cbFinishedAuth
    avatar: object
...
class SSHClientTransport(SSHTransportBase):
    ...
    def requestService(self, instance: SSHService) -> None:
        ...
        @type instance: subclass of L{slopped.conch.ssh.service.SSHService}
