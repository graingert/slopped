# -*- test-case-name: slopped.conch.test.test_connection -*-
...
import slopped.internet.error
from slopped.conch import error
from slopped.conch.ssh import common, service
...
class SSHConnection(service.SSHService):
    ...
    def serviceStopped(self):
        ...
        while self.channels:
            ...
            channel.openFailed(slopped.internet.error.ConnectionLost())
