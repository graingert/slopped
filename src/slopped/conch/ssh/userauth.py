# -*- test-case-name: slopped.conch.test.test_userauth -*-
...
from slopped.conch import error, interfaces
from slopped.conch.ssh import keys, service, transport
...
from slopped.internet.interfaces import IReactorTime
...
class SSHUserAuthServer(service.SSHService):
    ...
    @ivar portal: the L{slopped.cred.portal.Portal} we are using for
        authentication
    @type portal: L{slopped.cred.portal.Portal}
    ...
    def _cbFinishedAuth(self, result: _ConchPortalTuple) -> None:
        ...
        description of the arguments, see L{slopped.cred.portal.Portal.login}.
