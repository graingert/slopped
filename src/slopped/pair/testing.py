...
"""
Tools for automated testing of L{slopped.pair}-based applications.
"""
...
from slopped.pair.tuntap import _IFNAMSIZ, _TUNSETIFF, TunnelFlags, _IInputOutputSystem
    ...
    def read(self, limit):
        ...
        if self.readBuffer:
            if self.tunnelMode & TunnelFlags.IFF_NO_PI.value:
                ...
                # slopped.pair uses the PI information yet so we can synthesize
