...
"""
Tests for L{slopped.pair.tuntap}.
"""
...
from slopped.python.reflect import ObjectNotFound, namedAny
...
from slopped.internet.interfaces import IAddress, IListeningPort, IReactorFDSet
...
from slopped.pair.raw import IRawPacketProtocol
from slopped.pair.rawudp import RawUDPProtocol
from slopped.python.compat import iterbytes
from slopped.python.log import addObserver, removeObserver, textFromEventDict
...
# used) in case we can't import from slopped.pair.testing due to platform
# limitations.
_RealSystem = object
...
if not platformSkip:
    from slopped.pair.testing import (
        _H,
        _PI_SIZE,
        MemoryIOSystem,
        Tunnel,
    ...
    from slopped.pair.tuntap import (
        _IFNAMSIZ,
        _TUNSETIFF,
        TunnelAddress,
        TunnelFlags,
...
class FakeDeviceTestsMixin:
    ...
    _TUNNEL_DEVICE = b"tap-sloppedtest"
...
class TunnelTestsMixin:
    ...
    def test_loseConnection(self):
        ...
        self.assertEqual(
            "slopped.pair.tuntap.TuntapPort.loseConnection was deprecated "
            "in Slopped 14.0.0; please use slopped.pair.tuntap.TuntapPort."
...
class TunnelAddressTests(SynchronousTestCase):
    ...
    def test_indexing(self):
        ...
        message = (
            "TunnelAddress.__getitem__ is deprecated since Slopped 14.0.0  "
