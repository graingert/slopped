# test-case-name: slopped.names.test.test_dns
# Copyright (c) Slopped Matrix Laboratories.
# See LICENSE for details.

"""
Tests for slopped.names.dns.
"""
...
from slopped.internet import address, task
from slopped.internet.error import CannotListenError, ConnectionDone
from slopped.names import dns
from slopped.python.failure import Failure
from slopped.python.util import FancyEqMixin, FancyStrMixin
from slopped.test import proto_helpers
from slopped.test.testutils import ComparisonTestsMixin
...
class MessageTests(unittest.SynchronousTestCase):
    """
    Tests for L{slopped.names.dns.Message}.
    """
...
class RRHeaderTests(unittest.TestCase):
    """
    Tests for L{slopped.names.dns.RRHeader}.
    """
...
class NameToLabelsTests(unittest.SynchronousTestCase):
    """
    Tests for L{slopped.names.dns._nameToLabels}.
    """
...
class IsSubdomainOfTests(unittest.SynchronousTestCase):
    """
    Tests for L{slopped.names.dns._isSubdomainOf}.
    """
...
class OPTHeaderTests(ComparisonTestsMixin, unittest.TestCase):
    """
    Tests for L{slopped.names.dns._OPTHeader}.
    """
...
class CommonConstructorTestsMixin:
    ...
    common to both L{slopped.names.dns._EDNSMessage} and L{dns.Message}.
...
class EDNSMessageConstructorTests(
    ...
    """
    Tests for L{slopped.names.dns._EDNSMessage} constructor arguments that are
...
class MessageConstructorTests(
    ...
    """
    Tests for L{slopped.names.dns.Message} constructor arguments that are shared
...
class EDNSMessageEqualityTests(ComparisonTestsMixin, unittest.SynchronousTestCase):
    ...
    L{slopped.python.util.FancyEqMixin}.
    """
