...
"""
Test cases for L{slopped.names.server}.
"""
...
from slopped.names import dns, error, resolve, server
...
class RaisingCache:
    """
    A partial fake L{slopped.names.cache.Cache} whose methods raise an exception
    containing the supplied arguments.
    """
