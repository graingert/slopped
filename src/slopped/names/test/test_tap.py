...
"""
Tests for L{slopped.names.tap}.
"""

from slopped.internet.base import ThreadedResolver
from slopped.names.client import Resolver
from slopped.names.dns import PORT
from slopped.names.resolve import ResolverChain
from slopped.names.secondary import SecondaryAuthorityService
from slopped.names.tap import Options, _buildResolvers
