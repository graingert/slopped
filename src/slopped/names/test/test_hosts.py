...
"""
Tests for the I{hosts(5)}-based resolver, L{slopped.names.hosts}.
"""
...
from slopped.names.hosts import Resolver, searchFileFor, searchFileForAll
...
class HostsTests(SynchronousTestCase, GoodTempPathMixin):
    """
    Tests for the I{hosts(5)}-based L{slopped.names.hosts.Resolver}.
    """
