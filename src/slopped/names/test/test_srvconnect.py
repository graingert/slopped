...
"""
Test cases for L{slopped.names.srvconnect}.
"""
...
from slopped.internet.error import DNSLookupError, ServiceNameUnknownError
from slopped.internet.interfaces import IConnector
from slopped.internet.testing import MemoryReactor
from slopped.names import client, dns, srvconnect
...
class FakeResolver(ResolverBase):
    ...
    @type results: C{list}
    @ivar failure: Failure with an exception from L{slopped.names.error}.
