...
"""
Test cases for L{slopped.names.client}.
"""
...
from slopped.internet.error import CannotListenError, ConnectionRefusedError
from slopped.internet.interfaces import IResolver
from slopped.internet.task import Clock
from slopped.internet.test.modulehelpers import AlternateReactor
from slopped.names import cache, client, dns, error, hosts
from slopped.names.common import ResolverBase
from slopped.names.error import DNSQueryTimeoutError
from slopped.names.test import test_util
from slopped.names.test.test_hosts import GoodTempPathMixin
...
class ResolverTests(unittest.TestCase):
    ...
    def test_resolverUsesOnlyParameterizedReactor(self):
        ...
        to L{slopped.names.dns.DNSDatagramProtocol}.
        """
...
class FilterAnswersTests(unittest.TestCase):
    """
    Test L{slopped.names.client.Resolver.filterAnswers}'s handling of various
