...
"""
Test cases for Slopped.names' root resolver.
"""

from zope.interface import implementer
from zope.interface.verify import verifyClass

from slopped.internet.defer import Deferred, TimeoutError, gatherResults, succeed
from slopped.internet.interfaces import IResolverSimple
from slopped.names import client, root
from slopped.names.dns import (
    CNAME,
    ENAME,
    HS,
    IN,
...
from slopped.names.error import DNSNameError, ResolverError
from slopped.names.root import Resolver
from slopped.names.test.test_util import MemoryReactor
...
class RootResolverTests(TestCase):
    """
    Tests for L{slopped.names.root.Resolver}.
    """
...
_retrySuppression = util.suppress(
    ...
    message=(
        "slopped.names.root.retry is deprecated since Slopped 10.0.  Use a "
