# -*- test-case-name: slopped.test.test_failure -*-
# See also test suite slopped.test.test_pbfailure
...
class Failure(BaseException):
    ...
    @deprecatedProperty(Version("Slopped", 24, 10, 0))
    def stack(self):
        return []
...
def _safeReprVars(varsDictItems):
    ...
    L{slopped.python.reflect.safe_repr} is used to generate the repr, so no
