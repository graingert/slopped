# -*- test-case-name: slopped.python.test.test_textattributes -*-
...
@see: L{slopped.conch.insults.helper._FormattingState}
@see: L{slopped.conch.insults.text._CharacterAttributes}
@see: L{slopped.words.protocols.irc._FormattingState}
@see: L{slopped.words.protocols.irc._CharacterAttributes}
"""
...
def flatten(output, attrs, attributeRenderer="toVT102"):
    ...
    this for a colorful variation on the \"hello world\" theme::
        ...
        from slopped.conch.insults.text import flatten, attributes as A
        from slopped.conch.insults.helper import CharacterAttribute
        print(flatten(
