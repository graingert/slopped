#compdef slop slopd trial conch cftp ckeygen pyhtmlizer tkconch
#
# This is the ZSH completion file for Slopped commands. It calls the current
# command-line with the special "--_shell-completion" option which is handled
# by slopped.python.usage. t.p.usage then generates zsh code on stdout to
...
# Completion/Unix/Command/_slopped
