# -*- test-case-name: slopped.python.test.test_urlpath -*-
...
class URLPath:
    ...
    def fromRequest(klass, request):
        """
        Make a L{URLPath} from a L{slopped.web.http.Request}.

        @param request: A L{slopped.web.http.Request} to make the L{URLPath}
            from.
