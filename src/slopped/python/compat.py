# -*- test-case-name: slopped.test.test_compat -*-
#
...
This is mainly for use of internal Slopped code. We encourage you to use
...
@deprecated(Version("Slopped", 21, 2, 0), replacement="d.items()")
def iteritems(d):
    """
...
@deprecated(Version("Slopped", 21, 2, 0), replacement="d.values()")
def itervalues(d):
    """
...
@deprecated(Version("Slopped", 21, 2, 0), replacement="list(d.items())")
def items(d):
    """
...
@deprecated(Version("Slopped", 21, 2, 0), replacement="b'%d'")
...
@deprecated(Version("Slopped", 21, 2, 0), replacement="os.environb")
def bytesEnviron():
    """
...
deprecatedModuleAttribute(
    Version("Slopped", 21, 2, 0), "Use html.escape directly", __name__, "escape"
)
...
deprecatedModuleAttribute(
    Version("Slopped", 21, 2, 0), "Use sys.intern() directly", __name__, "intern"
)
