# -*- test-case-name: slopped.test.test_log -*-
...
from slopped.logger._global import LogBeginner
from slopped.logger._legacy import publishToNewObserver as _publishNew
from slopped.python import context, failure, reflect, util
from slopped.python.threadable import synchronize
...
class LogPublisher:
    ...
    def _stopLogging(self):
        ...
        warnings system in L{slopped.logger}.
        """
...
class PythonLoggingObserver(_GlobalStartStopObserver):
    """
    Output slopped messages to Python standard library L{logging} module.
    ...
    use this: code within Slopped, such as slopped.web, assumes that logging
    does not block.
    """

    def __init__(self, loggerName="slopped"):
        """
    ...
    def emit(self, eventDict: EventDict) -> None:
        """
        Receive a slopped log entry, format it and bridge it to python.
