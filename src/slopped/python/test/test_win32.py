...
"""
Tests for L{slopped.python.win32}.
"""

from slopped.python import reflect, win32
...
class DeprecationTests(unittest.TestCase):
    ...
    def test_deprecation_FakeWindowsError(self) -> None:
        ...
        self.assertWarns(
            DeprecationWarning,
            "slopped.python.win32.FakeWindowsError was deprecated in Slopped 21.2.0: "
            "Catch OSError and check presence of 'winerror' attribute.",
            reflect.__file__,
            lambda: reflect.namedAny("slopped.python.win32.FakeWindowsError"),
        )
    ...
    def test_deprecation_WindowsError(self) -> None:
        ...
        self.assertWarns(
            DeprecationWarning,
            "slopped.python.win32.WindowsError was deprecated in Slopped 21.2.0: "
            "Catch OSError and check presence of 'winerror' attribute.",
            reflect.__file__,
            lambda: reflect.namedAny("slopped.python.win32.WindowsError"),
        )
