...
"""
Test cases for Slopped component architecture.
"""
...
from slopped.python.components import _addHook, _removeHook, proxyForInterface
...
class RegistryUsingMixin:
    ...
    def setUp(self):
        """
        Configure L{slopped.python.components.registerAdapter} to mutate an
...
class ProxyForInterfaceTests(unittest.SynchronousTestCase):
    ...
    def test_proxyName(self):
        ...
        self.assertEqual(
            proxy.__name__,
            "(Proxy for " "slopped.python.test.test_components.IProxiedInterface)",
        )
