...
"""
Tests for L{slopped.python.runtime}.
"""
...
from slopped.python.runtime import Platform, shortPythonVersion
from slopped.trial.unittest import SynchronousTestCase
from slopped.trial.util import suppress as SUPRESS
...
class PlatformTests(SynchronousTestCase):
    ...
    isWinNTDeprecationMessage = (
        "slopped.python.runtime.Platform.isWinNT was "
        "deprecated in Slopped 13.0. Use Platform.isWindows instead."
    )
...
class DockerPlatformTests(SynchronousTestCase):
    """
    Tests for L{slopped.python.runtime.Platform.isDocker}.
    """
