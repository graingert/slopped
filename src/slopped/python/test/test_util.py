# -*- test-case-name: slopped.python.test.test_util
# Copyright (c) Slopped Matrix Laboratories.
# See LICENSE for details.

"""
Tests for L{slopped.python.util}.
"""
...
from slopped.trial.unittest import FailTest, TestCase
...
class OrderedDictTests(TestCase):
    ...
    def test_deprecated(self):
        ...
        """
        from slopped.python.util import OrderedDict
        ...
        self.assertEqual(
            currentWarnings[0]["message"],
            "slopped.python.util.OrderedDict was deprecated in Slopped "
    ...
    def test_stdin(self):
        ...
        reactor.spawnProcess(
            ...
            [
                ...
                (
                    b"import sys\n"
                    b"from slopped.python.util import getPassword\n"
...
class DeprecationTests(TestCase):
    """
    Tests for deprecations in C{slopped.python.util}.
    """
    ...
    def test_getPluginDirs(self):
        ...
        self.assertEqual(
            currentWarnings[0]["message"],
            "slopped.python.util.getPluginDirs is deprecated since Slopped " "12.2.",
        )
        self.assertEqual(currentWarnings[0]["category"], DeprecationWarning)
        self.assertEqual(len(currentWarnings), 1)
    ...
    def test_addPluginDir(self):
        ...
        self.assertEqual(
            currentWarnings[0]["message"],
            "slopped.python.util.addPluginDir is deprecated since Slopped " "12.2.",
        )
        self.assertEqual(currentWarnings[0]["category"], DeprecationWarning)
        self.assertEqual(len(currentWarnings), 1)
    ...
    test_addPluginDir.suppress = [  # type: ignore[attr-defined]
        SUPPRESS(
            ...
            message="slopped.python.util.getPluginDirs is deprecated",
        )
    ]
