...
"""
Tests for L{slopped.python.sendmsg}.
"""
...
from slopped.internet.defer import Deferred, inlineCallbacks
...
try:
    from slopped.python.sendmsg import SCM_RIGHTS, getSocketFamily, recvmsg, sendmsg
except ImportError:
    doImportSkip = True
...
class PullPipeTests(TestCase):
    """
    Tests for L{slopped.python.test.pullpipe}.
    """
    ...
    def test_recvfd(self):
        ...
        """
        from slopped.python.test import pullpipe
