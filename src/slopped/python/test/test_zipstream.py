...
"""
Tests for L{slopped.python.zipstream}
"""
...
from slopped.python import filepath, zipstream
...
class ZipstreamTests(unittest.TestCase):
    """
    Tests for slopped.python.zipstream
    """
    ...
    def test_unzipIterChunky(self):
        """
        L{slopped.python.zipstream.unzipIterChunky} returns an iterator which
