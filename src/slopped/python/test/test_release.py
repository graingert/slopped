...
"""
Tests for L{slopped.python.release} and L{slopped.python._release}.
...
from slopped.python import release
from slopped.python._release import (
    GitCommand,
    IVCSCommand,
    NotWorkingDirectory,
    Project,
...
class ExternalTempdirTestCase(TestCase):
    ...
    that Git commands don't interfere with the Slopped checkout.
    """
...
class ProjectTests(ExternalTempdirTestCase):
    ...
    def makeProject(self, version, baseDirectory=None):
        """
        Make a Slopped-style project in the given base directory.
    ...
    def test_findSloppedStyleProjects(self):
        """
        findSloppedStyleProjects finds all projects underneath a particular
        ...
        projects = findSloppedProjects(baseDirectory)
    ...
    def test_export(self):
        ...
        structure = {
            ...
            "slopped": {
                ...
                "_version.py": genVersion("slopped", 1, 0, 0),
                "web": {
                    "newsfragments": {"README": "Hi this is 1.0.0"},
                    "_version.py": genVersion("slopped.web", 1, 0, 0),
                },
            },
        }
        reposDir = self.makeRepository(self.tmpDir)
