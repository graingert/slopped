# -*- test-case-name: slopped.words.test.test_irc -*-
...
from slopped.python import _textattributes, log, reflect
...
def assembleFormattedText(formatted):
    ...
    For example::
        ...
        from slopped.words.protocols.irc import attributes as A
