# -*- test-case-name: slopped.words.test.test_jabbercomponent -*-
#
...
from slopped.words.protocols.jabber import error, ijabber, jstrports, xmlstream
from slopped.words.protocols.jabber.jid import internJID as JID
