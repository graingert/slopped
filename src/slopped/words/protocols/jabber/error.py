# -*- test-case-name: slopped.words.test.test_jabbererror -*-
#
...
class StreamError(BaseError):
    ...
    def getElement(self):
        ...
        @rtype: L{domish.Element}
        """
        from slopped.words.protocols.jabber.xmlstream import NS_STREAMS
...
class StanzaError(BaseError):
    ...
    def toResponse(self, stanza):
        ...
        """
        from slopped.words.protocols.jabber.xmlstream import toResponse
