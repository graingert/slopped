# -*- test-case-name: slopped.words.test.test_tap -*-
...
from slopped.application.service import MultiService
from slopped.cred import checkers, credentials, portal, strcred
from slopped.python import usage
from slopped.words import iwords, service
