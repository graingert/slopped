# -*- test-case-name: slopped.words.test.test_xmlstream -*-
#
...
usable. See Slopped Words for Jabber specific protocol support.
...
from slopped.words.xish import domish, utility
...
class BootstrapMixin:
    ...
    L{IProtocolFactory<slopped.internet.interfaces.IProtocolFactory>} to make
