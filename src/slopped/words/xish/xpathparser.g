# -*- test-case-name: slopped.words.test.test_xpath -*-
...
# This also means that the generated Python may not conform to Slopped's coding
...
from slopped.words.xish.xpath import AttribValue, BooleanValue, CompareValue
from slopped.words.xish.xpath import Function, IndexValue, LiteralValue
from slopped.words.xish.xpath import _AnyLocation, _Location
