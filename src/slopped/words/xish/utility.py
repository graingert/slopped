# -*- test-case-name: slopped.words.test.test_xishutil -*-
#
...
from slopped.words.xish import xpath
...
class EventDispatcher:
    ...
    be an L{Element<slopped.words.xish.domish.Element>} instance, which is
    ...
    is not restricted to L{Element<slopped.words.xish.domish.Element>}, but can
    be anything.
    ...
    def dispatch(self, obj, event=None):
        ...
        L{Element<slopped.words.xish.domish.Element>}. Otherwise, C{event}
...
class XmlPipe:
    ...
    Unlike Jabber
    L{XmlStream<slopped.words.protocols.jabber.xmlstream.XmlStream>}s, the sink
