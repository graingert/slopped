...
"""
Tests for L{slopped.words.protocols.jabber.xmlstream}.
"""
...
from slopped.internet.interfaces import IProtocolFactory
from slopped.python import failure
from slopped.test import proto_helpers
from slopped.trial import unittest
from slopped.words.protocols.jabber import error, ijabber, jid, xmlstream
from slopped.words.test.test_xmlstream import GenericXmlStreamFactoryTestsMixin
...
try:
    ...
    ssl = _ssl
    skipWhenNoSSL = (False, "")
    from slopped.internet._sslverify import ClientTLSOptions
