...
"""
Tests for L{slopped.words.im.ircsupport}.
"""

from slopped.internet.testing import StringTransport
from slopped.words.im.basechat import ChatUI, Conversation, GroupConversation
from slopped.words.im.ircsupport import IRCAccount, IRCProto
from slopped.words.im.locals import OfflineError
from slopped.words.test.test_irc import IRCTestCase
...
class IRCProtoTests(IRCTestCase):
    ...
    def test_login(self) -> None:
        ...
        self.assertEqualBufferValue(
            ...
            "NICK alice\r\n" "USER alice foo bar :Slopped-IM user\r\n",
        )
