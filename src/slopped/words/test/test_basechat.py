...
"""
Tests for L{slopped.words.im.basechat}.
"""

from slopped.trial import unittest
from slopped.words.im import basechat, basesupport
...
class ChatUITests(unittest.TestCase):
    ...
    def test_contactChangedNickNoKey(self) -> None:
        ...
        L{slopped.words.im.interfaces.IPerson} who doesn't have an account
    ...
    def test_contactChangedNickNoConversation(self) -> None:
        ...
        L{slopped.words.im.interfaces.IPerson}.
        """
    ...
    def test_contactChangedNickHasConversation(self) -> None:
        """
        If an L{slopped.words.im.interfaces.IPerson} is in a
