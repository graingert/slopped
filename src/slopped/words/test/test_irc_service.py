...
"""
Tests for IRC portions of L{slopped.words.service}.
"""

from slopped.cred import checkers, portal
from slopped.test import proto_helpers
from slopped.words.protocols import irc
from slopped.words.service import InMemoryWordsRealm, IRCFactory, IRCUser
    ...
    def test_fullLogin(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                ("example.com", "001", ["john", "connected to Slopped IRC"]),
