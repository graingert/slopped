...
"""
Tests for L{slopped.words.protocols.jabber.jid}.
"""

from slopped.trial import unittest
from slopped.words.protocols.jabber import jid
...
class JIDParsingTests(unittest.TestCase):
    ...
    # prepping done in slopped.words.protocols.jabber.xmpp_stringprep
