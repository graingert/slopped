...
"""
Tests for L{slopped.words.protocols.jabber.client}
"""
...
from slopped.words.protocols.jabber import client, error, jid, xmlstream
from slopped.words.protocols.jabber.sasl import SASLInitiatingInitializer
from slopped.words.xish import utility
