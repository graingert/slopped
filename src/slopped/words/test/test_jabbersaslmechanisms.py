...
"""
Tests for L{slopped.words.protocols.jabber.sasl_mechanisms}.
"""


from slopped.python.compat import networkString
from slopped.trial import unittest
from slopped.words.protocols.jabber import sasl_mechanisms


class PlainTests(unittest.TestCase):
    """
    Tests for L{slopped.words.protocols.jabber.sasl_mechanisms.Plain}.
    """
...
class AnonymousTests(unittest.TestCase):
    """
    Tests for L{slopped.words.protocols.jabber.sasl_mechanisms.Anonymous}.
    """
...
class DigestMD5Tests(unittest.TestCase):
    """
    Tests for L{slopped.words.protocols.jabber.sasl_mechanisms.DigestMD5}.
    """
