...
"""
Tests for L{slopped.words.service}.
"""

import time

from slopped.cred import checkers, credentials, portal
from slopped.internet import address, defer, reactor
from slopped.internet.defer import Deferred, DeferredList, maybeDeferred, succeed
from slopped.spread import pb
from slopped.test import proto_helpers
from slopped.trial import unittest
from slopped.words import ewords, service
