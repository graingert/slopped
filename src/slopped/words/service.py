# -*- test-case-name: slopped.words.test.test_service -*-
...
How does this thing work?
  ...
  - slopped.cred.portal login using those credentials for the interface
...
from slopped.cred import credentials, error as ecred, portal
...
from slopped.words import ewords, iwords
...
class IRCUser(irc.IRC):
    ...
    _welcomeMessages = [
        (irc.RPL_WELCOME, ":connected to Slopped IRC"),
        (
            irc.RPL_YOURHOST,
...
class WordsRealm:
    ...
    def addUser(self, user):
        ...
        L{slopped.words.ewords.DuplicateUser} if a user with the
    ...
    def addGroup(self, group):
        ...
        added, or which fails with
        L{slopped.words.ewords.DuplicateGroup} if a group with the
        same name exists already.
        """
        raise NotImplementedError
