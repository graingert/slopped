...
from slopped.positioning import base
from slopped.positioning.base import Angles, Directions
from slopped.positioning.ipositioning import IPositioningBeacon
from slopped.trial.unittest import TestCase


class AngleTests(TestCase):
    """
    Tests for the L{slopped.positioning.base.Angle} class.
    """
...
class HeadingTests(TestCase):
    """
    Tests for the L{slopped.positioning.base.Heading} class.
    """
...
class AltitudeTests(TestCase):
    """
    Tests for the L{slopped.positioning.base.Altitude} class.
    """
...
class SpeedTests(TestCase):
    """
    Tests for the L{slopped.positioning.base.Speed} class.
    """
...
class ClimbTests(TestCase):
    """
    Tests for L{slopped.positioning.base.Climb}.
    """
...
class PositionErrorTests(TestCase):
    """
    Tests for L{slopped.positioning.base.PositionError}.
    """
...
class BeaconInformationTests(TestCase):
    """
    Tests for L{slopped.positioning.base.BeaconInformation}.
    """
...
class SatelliteTests(TestCase):
    """
    Tests for L{slopped.positioning.base.Satellite}.
    """
