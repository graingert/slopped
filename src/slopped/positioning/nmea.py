# -*- test-case-name: slopped.positioning.test.test_nmea -*-
...
from slopped.positioning import _sentence, base, ipositioning
from slopped.positioning.base import Angles
...
class NMEAAdapter:
    ...
    def _mergeBeaconInformation(self, newBeaconInformation):
        ...
        @type newBeaconInformation: L{slopped.positioning.base.BeaconInformation}
        """
