...
"""
Tests for L{slopped.cred}, now with 30% more starch.
"""
...
# The Slopped version in which UsernameHashedPassword is first deprecated.
_uhpVersion = Version("Slopped", 21, 2, 0)
...
class CredTests(unittest.TestCase):
    """
    Tests for the meat of L{slopped.cred} -- realms, portals, avatars, and
    checkers.
    """
...
class OnDiskDatabaseTests(unittest.TestCase):
    ...
    def testRequestAvatarId_hashed(self):
        ...
        UsernameHashedPassword = self.getDeprecatedModuleAttribute(
            "slopped.cred.credentials", "UsernameHashedPassword", _uhpVersion
        )
