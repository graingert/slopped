...
from slopped.cred import checkers, credentials, error, strcred
from slopped.plugins import cred_anonymous, cred_file, cred_unix
...
class SSHCheckerTests(TestCase):
    ...
    L{slopped.conch.test.test_checkers.SSHPublicKeyCheckerTestCase}.
    """
...
class LimitingInterfacesTests(TestCase):
    ...
    L{slopped.cred.checkers.FilePasswordDB.hash} for more details.
    """
