...
from slopped.cred._digest import calcHA1, calcHA2, calcResponse
...
class IAnonymous(ICredentials):
    ...
    @see: L{slopped.cred.checkers.AllowAnonymousAccess}
    """
...
class UsernameHashedPassword:
    deprecatedModuleAttribute(
        ...
        "Use slopped.cred.credentials.UsernamePassword instead.",
