# -*- test-case-name: slopped.runner.test.test_procmon -*-
...
from slopped.internet import error, protocol, reactor as _reactor
...
class _Process:
    ...
    @deprecate.deprecated(incremental.Version("Slopped", 18, 7, 0))
...
class ProcessMonitor(service.Service):
    ...
    @deprecate.deprecatedProperty(incremental.Version("Slopped", 18, 7, 0))
    def processes(
        self,
    ...
    @deprecate.deprecated(incremental.Version("Slopped", 25, 5, 0))
