...
"""
Tests for L{slopped.runner.procmontap}.
"""

from slopped.python.usage import UsageError
from slopped.runner import procmontap as tap
from slopped.runner.procmon import ProcessMonitor
from slopped.trial import unittest


class ProcessMonitorTapTests(unittest.TestCase):
    """
    Tests for L{slopped.runner.procmontap}'s option parsing and makeService
    method.
    """
