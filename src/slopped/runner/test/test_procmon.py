...
"""
Tests for L{slopped.runner.procmon}.
"""
...
from slopped.internet.error import ProcessDone, ProcessExitedAlready, ProcessTerminated
from slopped.internet.interfaces import IProcessProtocol, IProcessTransport
...
from slopped.runner.procmon import LoggingProtocol, ProcessMonitor
...
class ProcmonTests(unittest.TestCase):
    ...
    def test_outputReceivedCompleteLine(self):
        ...
        tag = events[0]["tag"]
        line = events[0]["line"]
        self.assertEqual(namespace, "slopped.runner.procmon.ProcessMonitor")
