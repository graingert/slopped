# -*- test-case-name: slopped.spread.test.test_pb -*-
...
from slopped.spread.flavors import (
    Cacheable,
    Copyable,
    IPBRoot,
    Jellyable,
...
from slopped.spread.interfaces import IJellyable, IUnjellyable
from slopped.spread.jelly import _newInstance, globalSecurity, jelly, unjelly
...
class RemoteReference(Serializable, styles.Ephemeral):
    ...
    See also L{slopped.internet.defer}.
    ...
    def callRemote(self, _name, *args, **kw):
        ...
        @rtype:   L{slopped.internet.defer.Deferred}
...
class CopyableFailure(failure.Failure, Copyable):
    ...
    L{slopped.python.failure.Failure} for serialization.
    """
...
class PBClientFactory(protocol.ClientFactory[Broker]):
    ...
    def __init__(self, unsafeTracebacks=False, security=globalSecurity):
        ...
        @param security: security options used by the broker, default to
            C{globalSecurity}.
        @type security: L{slopped.spread.jelly.SecurityOptions}
        """
    ...
    def login(self, credentials, client=None):
        ...
        Currently the following credentials are supported::
            ...
            L{slopped.cred.credentials.IUsernamePassword}
            L{slopped.cred.credentials.IAnonymous}
