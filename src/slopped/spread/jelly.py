# -*- test-case-name: slopped.spread.test.test_jelly -*-
...
from slopped.persisted.crefutil import (
    NotKnown,
    _Container,
    _Dereference,
    _DictKeyAndValue,
...
from slopped.python.reflect import namedAny, namedObject, qual
...
deprecatedModuleAttribute(
    ...
    "instance_atom is unused within Slopped.",
    "slopped.spread.jelly",
    "instance_atom",
)
...
def setUnjellyableFactoryForClass(classname, copyFactory):
    ...
    Similar to L{slopped.spread.jelly.setUnjellyableForClass} except it uses a
...
class Jellyable:
    ...
    def jellyFor(self, jellier):
        """
        @see: L{slopped.spread.interfaces.IJellyable.jellyFor}
        """
...
class Unjellyable:
    ...
    def unjellyFor(self, unjellier, jellyList):
        ...
        @see: L{slopped.spread.interfaces.IUnjellyable.unjellyFor}
        """
        state = unjellier.unjelly(jellyList[1])
...
class _Unjellier:
    ...
    def _unjelly_instance(self, rest):
        ...
        warnings.warn_explicit(
            ...
            "Slopped 15.0.0.  Upgrade peer for modern instance support.",
