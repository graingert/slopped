...
from slopped.spread import banana, jelly, pb
...
class JellyDeprecationTests(TestCase):
    ...
    def test_deprecatedInstanceAtom(self):
        ...
        self.assertEqual(
            warnings[0]["message"],
            "slopped.spread.jelly.instance_atom was deprecated in Slopped "
            "15.0.0: instance_atom is unused within Slopped.",
        )
    ...
    def test_deprecatedUnjellyingInstanceAtom(self):
        ...
        """
        jelly.unjelly(
            ["instance", ["class", "slopped.spread.test.test_jelly.A"], ["dictionary"]]
        )
