# -*- test-case-name: slopped.test.test_sob -*-
...
from slopped.python import log, runtime
...
class Persistent:
    ...
    def _getStyle(self):
        if self.style == "source":
            from slopped.persisted.aot import jellyToSource as dumpFunc
...
def load(filename, style):
    ...
    mode = "r"
    if style == "source":
        from slopped.persisted.aot import unjellyFromSource as _load
    else:
