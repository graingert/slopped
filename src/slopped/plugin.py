...
from slopped.python.components import getAdapterFactory
...
def getCache(module):
    ...
    # information is already represented internally in slopped.python.modules,
...
def _pluginsPackage() -> types.ModuleType:
    import slopped.plugins as package
