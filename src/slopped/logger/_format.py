# -*- test-case-name: slopped.logger.test.test_format -*-
...
from slopped.python._tzhelper import FixedOffsetTimeZone
from slopped.python.failure import Failure
from slopped.python.reflect import safe_repr
...
def formatTime(
    ...
    Example::
        ...
        >>> from slopped.logger import formatTime
        >>>
        >>> t = time()
        >>> formatTime(t)
...
def formatEventAsClassicLogText(
    ...
    Example::
        ...
        >>> from time import time
        >>> from slopped.logger import formatEventAsClassicLogText
        >>> from slopped.logger import LogLevel
        >>>
