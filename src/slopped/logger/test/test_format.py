...
"""
Test cases for L{slopped.logger._format}.
"""
...
from slopped.python.test.test_tzhelper import addTZCleanup, mktime, setTZ
...
class FormattingTests(unittest.TestCase):
    ...
    def format(self, logFormat: AnyStr, **event: object) -> str:
        """
        Create a Slopped log event dictionary from C{event} with the given
