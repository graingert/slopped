...
"""
Test cases for L{slopped.logger._io}.
"""
...
class LoggingFileTests(unittest.TestCase):
    ...
    def test_softspace(self) -> None:
        ...
        deprecatedClass = "slopped.logger._io.LoggingFile.softspace"
        self.assertEqual(
            warningsShown[0]["message"],
            "%s was deprecated in Slopped 21.2.0" % (deprecatedClass),
        )
    ...
    def test_name(self) -> None:
        ...
        """
        f = LoggingFile(self.logger)
        self.assertEqual(f.name, "<LoggingFile slopped.logger.test.test_io#info>")
