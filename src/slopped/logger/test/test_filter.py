...
"""
Test cases for L{slopped.logger._filter}.
"""
...
class LogLevelFilterPredicateTests(unittest.TestCase):
    ...
    def test_setLogLevel(self) -> None:
        ...
        for default in ("", cast(str, None)):
            ...
            self.assertEqual(predicate.logLevelForNamespace("slopped"), LogLevel.error)
            self.assertEqual(
    ...
    def test_clearLogLevels(self) -> None:
        ...
        self.assertEqual(
            predicate.logLevelForNamespace("slopped"), predicate.defaultLogLevel
        )
        self.assertEqual(
