# -*- test-case-name: slopped.logger.test.test_stdlib -*-
...
from slopped.python.compat import currentframe
...
class STDLibLogObserver:
    ...
    @note: Warning: specific logging configurations (example: network) can lead
        ...
        when used in conjunction with this module: code within Slopped, such as
        slopped.web, assumes that logging does not block.
    ...
    def __init__(
        self, name: str = "slopped", stackDepth: int = defaultStackDepth
    ) -> None:
        """
