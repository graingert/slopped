# -*- test-case-name: slopped.application.test.test_internet,slopped.test.test_application,slopped.test.test_cooperator -*-
...
<slopped.internet.interfaces.IStreamServerEndpoint>}
as an L{IService}. See also L{slopped.application.strports.service} for
...
from slopped.internet.defer import CancelledError
...
class _AbstractServer(_VolatileDataService):
    ...
    @type _port: a provider of L{slopped.internet.interfaces.IListeningPort}.
    """
    ...
    def _getPort(self):
        ...
        @rtype: an object providing
            L{slopped.internet.interfaces.IListeningPort}.
        """
        return getattr(
...
class _AbstractClient(_VolatileDataService):
    ...
    @type _connection: a provider of L{slopped.internet.interfaces.IConnector}.
    """
    ...
    def _getConnection(self):
        ...
        @rtype: an object providing L{slopped.internet.interfaces.IConnector}.
        """
...
stop listening. See slopped.internet.interfaces for documentation
...
class TimerService(_VolatileDataService):
    ...
    @ivar clock: Source of time. This defaults to L{None} which is
        causes L{slopped.internet.reactor} to be used.
...
class CooperatorService(service.Service):
    """
    Simple L{service.IService} which starts and stops a L{slopped.internet.task.Cooperator}.
    """
...
class StreamServerEndpointService(service.Service):
    ...
    @ivar endpoint: An L{IStreamServerEndpoint
        <slopped.internet.interfaces.IStreamServerEndpoint>} provider
    ...
    def stopService(self):
        ...
        @return: a L{Deferred<slopped.internet.defer.Deferred>} which fires
