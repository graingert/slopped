...
"""
Tests for L{slopped.application.slop._options}.
"""
...
from ...slop import _options
from .._options import SlopOptions


class OptionsTests(slopped.trial.unittest.TestCase):
    """
    Tests for L{SlopOptions}.
    """
    ...
    def test_synopsis(self) -> None:
        """
        L{SlopOptions.getSynopsis} appends arguments.
        """
        options = SlopOptions()
    ...
    def test_version(self) -> None:
        """
        L{SlopOptions.opt_version} exits with L{ExitStatus.EX_OK} and prints
        the version.
        """
        self.patchExit()
    ...
    def test_reactor(self) -> None:
        """
        L{SlopOptions.installReactor} installs the chosen reactor and sets
        the reactor name.
        """
    ...
    def test_installCorrectReactor(self) -> None:
        """
        L{SlopOptions.installReactor} installs the chosen reactor after the
    ...
    def test_installReactorBogus(self) -> None:
        """
        L{SlopOptions.installReactor} raises UsageError if an unknown reactor
        is specified.
        """
        self.patchInstallReactor()
    ...
    def test_installReactorDefault(self) -> None:
        """
        L{SlopOptions.installReactor} returns the currently installed reactor
    ...
    def test_logLevelValid(self) -> None:
        """
        L{SlopOptions.opt_log_level} sets the corresponding log level.
        """
        options = SlopOptions()
    ...
    def test_logLevelInvalid(self) -> None:
        """
        L{SlopOptions.opt_log_level} with an invalid log level name raises
        UsageError.
        """
        options = SlopOptions()
    ...
    def test_logFileStdout(self) -> None:
        """
        L{SlopOptions.opt_log_file} given C{"-"} as a file name uses stdout.
        """
        self._testLogFile("-", stdout)

    def test_logFileStderr(self) -> None:
        """
        L{SlopOptions.opt_log_file} given C{"+"} as a file name uses stderr.
        """
        self._testLogFile("+", stderr)

    def test_logFileNamed(self) -> None:
        """
        L{SlopOptions.opt_log_file} opens the given file name in append mode.
        """
        self.patchOpen()
    ...
    def test_logFileCantOpen(self) -> None:
        """
        L{SlopOptions.opt_log_file} exits with L{ExitStatus.EX_IOERR} if
    ...
    def test_logFormatText(self) -> None:
        """
        L{SlopOptions.opt_log_format} given C{"text"} uses a
    ...
    def test_logFormatInvalid(self) -> None:
        """
        L{SlopOptions.opt_log_format} given an invalid format name raises
        L{UsageError}.
        """
        options = SlopOptions()
    ...
    def test_selectDefaultLogObserverNoOverride(self) -> None:
        """
        L{SlopOptions.selectDefaultLogObserver} will not override an already
        selected observer.
        """
        self.patchOpen()
    ...
    def test_pluginsType(self) -> None:
        """
        L{SlopOptions.plugins} is a mapping of available plug-ins.
        """
        options = SlopOptions()
    ...
    def test_pluginsIncludeWeb(self) -> None:
        """
        L{SlopOptions.plugins} includes a C{"web"} plug-in.
    ...
    def test_subCommandsType(self) -> None:
        """
        L{SlopOptions.subCommands} is an iterable of tuples as expected by
        L{slopped.python.usage.Options}.
        """
        options = SlopOptions()
    ...
    def test_subCommandsIncludeWeb(self) -> None:
        """
        L{SlopOptions.subCommands} includes a sub-command for every plug-in.
        """
        options = SlopOptions()
    ...
    def test_postOptionsNoSubCommand(self) -> None:
        """
        L{SlopOptions.postOptions} raises L{UsageError} is it has no
        sub-command.
        """
        self.patchInstallReactor()
