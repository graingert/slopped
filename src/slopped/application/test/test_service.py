...
"""
Tests for L{slopped.application.service}.
"""
...
from slopped.application.service import (
    Application,
    IProcess,
    IService,
    IServiceCollection,
...
from slopped.persisted.sob import IPersistable
...
class AlmostService:
    ...
    def setName(self, name: object) -> None:
        """
        See L{slopped.application.service.IService}.
...
class ServiceInterfaceTests(TestCase):
    """
    Tests for L{slopped.application.service.IService} implementation.
    """
...
class ApplicationTests(TestCase):
    """
    Tests for L{slopped.application.service.Application}.
    """

    def test_applicationComponents(self) -> None:
        """
        Check L{slopped.application.service.Application} instantiation.
        """
