...
"""
Tests for L{slopped.application.runner._pidfile}.
"""
...
class PIDFileTests(slopped.trial.unittest.TestCase):
    """
    Tests for L{PIDFile}.
    """
...
class NonePIDFileTests(slopped.trial.unittest.TestCase):
    """
