...
"""
Implementation of L{slopped.application.internet.ClientService}, particularly
...
from slopped.application.service import Service
    ...
    def whenConnected(
        ...
        @return: a Deferred that fires with a protocol produced by the factory
            passed to C{__init__}.  It may:
                ...
                - fail with e.g.
                  L{DNSLookupError<slopped.internet.error.DNSLookupError>} or
                  L{ConnectionRefusedError<slopped.internet.error.ConnectionRefusedError>}
