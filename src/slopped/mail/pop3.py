# -*- test-case-name: slopped.mail.test.test_pop3 -*-
#
...
from slopped.internet import defer, interfaces, task
from slopped.mail import smtp
from slopped.mail._except import POP3ClientError, POP3Error, _POP3MessageDeleted
...
def formatStatResponse(msgs):
    ...
    L{Cooperator <slopped.internet.task.Cooperator>}.
                ...
                def ebMessage(err):
                    ...
                    if errcls is not None:
                        if errcls is IndexError:
                            ...
                            warnings.warn(
                                "slopped.mail.pop3.IMailbox.listMessages may "
...
class POP3Client(basic.LineOnlyReceiver):
    ...
    def __init__(self):
        ...
        warnings.warn(
            "slopped.mail.pop3.POP3Client is deprecated, "
            "please use slopped.mail.pop3.AdvancedPOP3Client "
            "instead.",
            DeprecationWarning,
            stacklevel=3,
        )
...
from slopped.mail._except import (
...
from slopped.mail._pop3client import POP3Client as AdvancedPOP3Client
