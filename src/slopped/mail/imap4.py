# -*- test-case-name: slopped.mail.test.test_imap.IMAP4HelperTests -*-
...
from slopped.internet.defer import maybeDeferred
...
from slopped.python import log, text
from slopped.python.compat import (
    _matchingString,
    iterbytes,
    nativeString,
    networkString,
...
class IMAP4Server(basic.LineReceiver, policies.TimeoutMixin):
    ...
    IDENT = b"Slopped IMAP4rev1 Ready"
