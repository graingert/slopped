...
"""
Credential managers for L{slopped.mail}.
"""
...
from slopped.mail._except import IllegalClientResponse
from slopped.mail.interfaces import IChallengeResponse, IClientAuthentication
