...
from slopped.mail import bounce
...
class BounceTests(unittest.TestCase):
    ...
    def test_bounceMessageUnicode(self) -> None:
        """
        L{slopped.mail.bounce.generateBounce} can accept L{unicode}.
        """
...
"""
    ...
    def test_bounceMessageBytes(self) -> None:
        """
        L{slopped.mail.bounce.generateBounce} can accept L{bytes}.
        """
        fromAddress, to, s = bounce.generateBounce(
            BytesIO(
                b"""\
...
"""
    ...
    def test_bounceMessageCustomTranscript(self) -> None:
        """
        Pass a custom transcript message to L{slopped.mail.bounce.generateBounce}.
        """
        fromAddress, to, s = bounce.generateBounce(
            BytesIO(
                b"""\
...
"""
    ...
    def _bounceBigMessage(
        ...
        """
        Pass a really big message to L{slopped.mail.bounce.generateBounce}.
        """
        fromAddress, to, s = bounce.generateBounce(
    ...
    def test_bounceBigMessage(self) -> None:
        """
        L{slopped.mail.bounce.generateBounce} with big L{unicode} and
        L{bytes} messages.
        """
        header = b"""\
From: Moshe Zadka <moshez@example.com>
