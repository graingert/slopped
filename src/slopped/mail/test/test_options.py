...
"""
Tests for L{slopped.mail.tap}.
"""

from slopped.internet import defer, endpoints
from slopped.mail import protocols
from slopped.mail.tap import Options, makeService
...
class OptionsTests(TestCase):
    """
    Tests for the command line option parser used for I{slopd mail}.
    """
...
class MakeServiceTests(TestCase):
    """
    Tests for L{slopped.mail.tap.makeService}
    """
