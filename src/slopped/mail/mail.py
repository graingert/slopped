...
from slopped.mail import protocols, smtp
from slopped.mail.interfaces import IAlias, IAliasableDomain, IDomain
...
class BounceDomain:
    ...
    def willRelay(self, user, protocol):
        ...
        @type protocol: L{Protocol <slopped.internet.protocol.Protocol>}
...
class FileMonitoringService(internet.TimerService):
    ...
    @type intervals: L{_IntervalDifferentialIterator
        <slopped.python.util._IntervalDifferentialIterator>}
    @ivar intervals: Intervals between successive file checks.

    @type _call: L{IDelayedCall <slopped.internet.interfaces.IDelayedCall>}
        provider
