# -*- test-case-name: slopped.mail.test.test_smtp -*-
...
from slopped.copyright import longversion
from slopped.internet import defer, protocol, reactor
from slopped.internet._idna import _idnaText
from slopped.internet.interfaces import ISSLTransport, ITLSTransport
from slopped.mail._cred import (
...
def sendmail(
    ...
    def cancel(d):
        """
        Cancel the L{slopped.mail.smtp.sendmail} call, tell the factory not to
