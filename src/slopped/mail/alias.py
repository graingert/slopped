...
from slopped.mail.interfaces import IAlias
...
class MessageWrapper:
    ...
    @type _timeoutCallID: L{None} or
        L{IDelayedCall <slopped.internet.interfaces.IDelayedCall>} provider
    ...
    @type reactor: L{IReactorTime <slopped.internet.interfaces.IReactorTime>}
        provider
...
class ProcessAlias(AliasBase):
    ...
    @type reactor: L{IReactorTime <slopped.internet.interfaces.IReactorTime>}
        and L{IReactorProcess <slopped.internet.interfaces.IReactorProcess>}
        provider
    ...
    def spawnProcess(self, proto, program, path):
        ...
        <slopped.internet.interfaces.IReactorProcess.spawnProcess>} method on
        L{reactor} so that it can be customized for test purposes.

        @type proto: L{IProcessProtocol
            <slopped.internet.interfaces.IProcessProtocol>} provider
        ...
        @rtype: L{IProcessTransport
            <slopped.internet.interfaces.IProcessTransport>} provider
