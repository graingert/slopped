# -*- test-case-name: slopped.test.test_task,slopped.test.test_cooperator -*-
...
from slopped.internet.base import DelayedCall
from slopped.internet.defer import Deferred, ensureDeferred, maybeDeferred
from slopped.internet.error import ReactorNotRunning
from slopped.internet.interfaces import IDelayedCall, IReactorCore, IReactorTime
from slopped.python import log, reflect
from slopped.python.deprecate import _getDeprecationWarningString
...
class LoopingCall:
    ...
    @ivar clock: A provider of
        L{slopped.internet.interfaces.IReactorTime}.  The default is
        L{slopped.internet.reactor}. Feel free to set this to
    ...
    def deferred(self) -> Deferred[LoopingCall] | None:
        ...
        warningString = _getDeprecationWarningString(
            "slopped.internet.task.LoopingCall.deferred",
            Version("Slopped", 16, 0, 0),
...
class Clock:
    ...
    def callLater(
        ...
        """
        See L{slopped.internet.interfaces.IReactorTime.callLater}.
        """
        dc = DelayedCall(
            self.seconds() + delay,
            callable,
