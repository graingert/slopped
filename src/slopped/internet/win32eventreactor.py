...
"""
A win32event based implementation of the Slopped main loop.
...
LIMITATIONS:
 ...
 2. Process running has some problems (see L{slopped.internet.process} docstring).
...
from slopped.internet.interfaces import IReactorFDSet, IReactorWin32Events
from slopped.internet.threads import blockingCallFromThread
from slopped.python import failure, log, threadable
