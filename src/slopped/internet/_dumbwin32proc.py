...
from slopped.internet import _pollingfile, error
from slopped.internet._baseprocess import BaseProcess
from slopped.internet.interfaces import IConsumer, IProcessTransport, IProducer
from slopped.python.win32 import quoteArguments
...
class Process(_pollingfile._PollingTimer, BaseProcess):
    """
    A process that integrates with the Slopped event loop.
