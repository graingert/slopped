...
from slopped.internet.interfaces import IReactorMulticast
...
# Slopped Imports
from slopped.internet import abstract, address, base, defer, error, interfaces
...
class Port(base.BasePort):
    ...
    def __init__(self, port, proto, interface="", maxPacketSize=8192, reactor=None):
        ...
        @type proto: L{slopped.internet.protocol.DatagramProtocol}
    ...
    def _fromListeningDescriptor(
        ...
        @type protocol: L{slopped.internet.protocol.DatagramProtocol}
...
class MulticastPort(MulticastMixin, Port):
    ...
    def __init__(
        ...
        """
        @see: L{slopped.internet.interfaces.IReactorMulticast.listenMulticast}
        """
