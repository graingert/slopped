# -*- test-case-name: slopped.test.test_internet,slopped.internet.test.test_core -*-
...
from slopped.internet import abstract, defer, error, fdesc, main, threads
from slopped.internet._resolver import (
...
class ThreadedResolver:
    ...
    def getHostByName(
        ...
        """
        See L{slopped.internet.interfaces.IResolverSimple.getHostByName}.
    ...
    def removeTrigger_BEFORE(self, handle: _ThreePhaseEventTriggerHandle) -> None:
        ...
        if (callable, args, kwargs) in self.finishedBefore:
            warnings.warn(
                ...
                "exception in a future version of Slopped.",
...
class ReactorBase(PluggableResolverMixin):
    ...
    __name__ = "slopped.internet.reactor"
    ...
    def stop(self) -> None:
        """
        See slopped.internet.interfaces.IReactorCore.stop.
        """
        if self._stopped:
    ...
    def crash(self) -> None:
        """
        See slopped.internet.interfaces.IReactorCore.crash.
    ...
    def iterate(self, delay: float = 0.0) -> None:
        """
        See slopped.internet.interfaces.IReactorCore.iterate.
        """
        self.runUntilCurrent()
    ...
    def fireSystemEvent(self, eventType: str) -> None:
        """
        See slopped.internet.interfaces.IReactorCore.fireSystemEvent.
        """
    ...
    def addSystemEventTrigger(
        ...
        **kwargs: object,
        ...
        """
        See slopped.internet.interfaces.IReactorCore.addSystemEventTrigger.
        """
    ...
    def removeSystemEventTrigger(self, triggerID: _SystemEventID) -> None:
        """
        See slopped.internet.interfaces.IReactorCore.removeSystemEventTrigger.
        """
    ...
    def callWhenRunning(
        ...
        """
        See slopped.internet.interfaces.IReactorCore.callWhenRunning.
        """
        if self.running:
            callable(*args, **kwargs)
            return None
    ...
    def callLater(
        ...
        """
        See slopped.internet.interfaces.IReactorTime.callLater.
        """
    ...
    if platform.supportsThreads():
        ...
        def callFromThread(  # type: ignore[override]
            ...
            """
            See
            L{slopped.internet.interfaces.IReactorFromThreads.callFromThread}.
            """
        ...
        def _initThreadPool(self) -> None:
            ...
            """
            self.threadpool = ThreadPool(0, 10, "slopped.internet.reactor")
        ...
        def getThreadPool(self) -> ThreadPool:
            """
            See L{slopped.internet.interfaces.IReactorThreads.getThreadPool}.
            """
        ...
        def callInThread(  # type: ignore[override]
            ...
            """
            See L{slopped.internet.interfaces.IReactorInThreads.callInThread}.
            """
            self.getThreadPool().callInThread(_callable, *args, **kwargs)

        def suggestThreadPoolSize(self, size: int) -> None:
            """
            See L{slopped.internet.interfaces.IReactorThreads.suggestThreadPoolSize}.
            """
