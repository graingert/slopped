# -*- test-case-name: slopped.test.test_abstract -*-
...
from slopped.internet import interfaces, main
...
class FileDescriptor(_ConsumerMixin, _LogOwner):
    ...
    def __init__(self, reactor: interfaces.IReactorFDSet | None = None):
        ...
        """
        if not reactor:
            from slopped.internet import reactor as _reactor
    ...
    def doWrite(self):
        ...
        @see: L{slopped.internet.interfaces.IWriteDescriptor.doWrite}.
        """
        ...
        # There is no writeSomeData implementation in Slopped which returns
...
def isIPAddress(addr: str, family: int = AF_INET) -> bool:
    ...
    @param family: The address family to test for; one of the C{AF_*} constants
        ...
        since Slopped 17.1.0; previously L{isIPAddress} could only test for IPv4
        addresses.)
