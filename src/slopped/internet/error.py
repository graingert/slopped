...
"""
Exceptions and errors for use in slopped.internet modules.
"""
...
class ConnectionAborted(ConnectionLost):
    ...
    L{slopped.internet.interfaces.ITCPTransport.abortConnection}.
