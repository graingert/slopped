# -*- test-case-name: slopped.internet.test.test_sigchld -*-
...
class _WithSignalHandling:
    ...
    def install(self) -> None:
        """
        Install the signal handlers for the Slopped event loop.
        """
...
class _MultiSignalHandling:
    ...
    @ivar _installed: If L{install} has been called but L{uninstall} has not.
        ...
        during test suite runs) because slopped.internet.reactormixins doesn't
