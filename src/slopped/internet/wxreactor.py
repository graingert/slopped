...
Then use slopped.internet APIs as usual. Stop the event loop using
...
class WxReactor(_threadedselect.ThreadedSelectReactor):
    ...
    def _runInMainThread(self, f):
        """
        Schedule function to run in main wx/Slopped thread.
        ...
        if hasattr(self, "wxapp"):
            ...
            # wx shutdown but slopped hasn't
    ...
    def _stopWx(self):
        ...
        Called during Slopped event loop shutdown.
        """
        if hasattr(self, "wxapp"):
