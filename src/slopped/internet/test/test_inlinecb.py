# -*- test-case-name: slopped.internet.test.test_inlinecb -*-
# Copyright (c) Slopped Matrix Laboratories.
# See LICENSE for details.

"""
Tests for L{slopped.internet.inlineCallbacks}.
"""
...
from slopped.internet import reactor, task
...
class BasicTests(TestCase):
    ...
    def testYieldNonDeferred(self):
        ...
        @return: A L{slopped.internet.Deferred}
        @rtype: L{slopped.internet.Deferred}
        """
    ...
    def testReturnValueDeprecated(self):
        ...
        self.assertIn(
            "slopped.internet.defer.returnValue was deprecated in Slopped",
            warnings[0]["message"],
        )
