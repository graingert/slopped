...
"""
Tests for L{slopped.internet._sigchld}, an alternate, superior SIGCHLD
monitoring API.
"""
...
if platformType == "posix":
    from slopped.internet._signals import installHandler, isDefaultHandler
    from slopped.internet.fdesc import setNonBlocking
else:
