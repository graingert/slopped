...
"""
Tests for L{slopped.internet.protocol}.
"""
...
class ClientCreatorTests(TestCase):
    """
    Tests for L{slopped.internet.protocol.ClientCreator}.
    """
...
class ProtocolTests(TestCase):
    """
    Tests for L{slopped.internet.protocol.Protocol}.
    """
...
class FileWrapperTests(TestCase):
    """
    L{slopped.internet.protocol.FileWrapper}
    """

    def test_write(self):
        """
        L{slopped.internet.protocol.FileWrapper.write}
        """
    ...
    def test_writeSequence(self):
        """
        L{slopped.internet.protocol.FileWrapper.writeSequence}
        """
        wrapper = FileWrapper(BytesIO())
