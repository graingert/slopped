...
"""
Tests for L{slopped.internet._baseprocess} which implements process-related
...
from slopped.python.deprecate import getWarningMethod, setWarningMethod
...
class BaseProcessTests(TestCase):
    ...
    def test_callProcessExitedMissing(self):
        ...
        self.assertEqual(
            message,
            "Since Slopped 8.2, IProcessProtocol.processExited is required.  "
        ...
        # any part of Slopped or a random part of the application's code, which
