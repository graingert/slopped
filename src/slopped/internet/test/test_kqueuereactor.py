...
"""
Tests for L{slopped.internet.kqueuereactor}.
"""
...
try:
    from slopped.internet.kqreactor import KQueueReactor, _IKQueue
...
class KQueueTests(TestCase):
    ...
    L{slopped.internet.test.reactormixins.ReactorBuilder}.
    """
