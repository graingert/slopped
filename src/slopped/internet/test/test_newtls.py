...
"""
Tests for L{slopped.internet._newtls}.
"""
...
from slopped.internet.test.test_tcp import TCPCreator
from slopped.internet.test.test_tls import (
...
try:
    from slopped.internet import _newtls as __newtls
...
class ProducerTestsMixin(ReactorBuilder, TLSMixin, ContextGeneratingMixin):
    ...
    if not _newtls:
        skip = "Could not import slopped.internet._newtls"
