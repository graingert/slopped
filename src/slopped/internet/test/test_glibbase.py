...
"""
Tests for slopped.internet.glibbase.
"""


import sys

from slopped.internet._glibbase import ensureNotImported
...
try:
    from slopped.internet import gireactor as _gireactor
except ImportError:
    gireactor = None
else:
...
class GlibReactorBaseTests(TestCase):
    """
    Tests for the private C{slopped.internet._glibbase.GlibReactorBase}
    done via the public C{slopped.internet.gireactor.PortableGIReactor}
    """
