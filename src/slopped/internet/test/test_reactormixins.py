"""
Tests L{slopped.internet.test.reactormixins}, the reactor-testing support
module.
"""
...
from slopped.trial._dist.test.matchers import matches_result
from slopped.trial.reporter import TestResult
from slopped.trial.runner import TestLoader
from slopped.trial.unittest import SynchronousTestCase, TestSuite
...
class ReactorBuilderTests(SynchronousTestCase):
    ...
    def test_buildReactorFails(self) -> None:
        ...
        class BrokenReactorFactory(ReactorBuilder, SynchronousTestCase):
            _reactors = [
                "slopped.internet.test.test_reactormixins.unsupportedReactor",
            ]
