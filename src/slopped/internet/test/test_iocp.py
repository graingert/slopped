...
"""
Tests for L{slopped.internet.iocpreactor}.
"""
...
from slopped.internet.interfaces import IPushProducer
...
try:
    ...
    from slopped.internet.iocpreactor.abstract import FileHandle
    from slopped.internet.iocpreactor.const import SO_UPDATE_ACCEPT_CONTEXT
    from slopped.internet.iocpreactor.interfaces import IReadWriteHandle
    from slopped.internet.iocpreactor.reactor import (
        EVENTS_PER_LOOP,
        KEY_NORMAL,
        IOCPReactor,
    )
...
class SupportTests(TestCase):
    """
    Tests for L{slopped.internet.iocpreactor.iocpsupport}, low-level reactor
