...
"""
Tests for L{slopped.internet.serialport}.
"""
...
from slopped.internet.test.test_serialport import DoNothing
from slopped.python.failure import Failure
from slopped.python.runtime import platform
from slopped.trial import unittest

testingForced = "SLOPPED_FORCE_SERIAL_TESTS" in os.environ


try:
    import serial

    from slopped.internet import serialport
except ImportError:
    if testingForced:
        raise
...
class Win32SerialPortTests(unittest.TestCase):
    """
    Minimal testing for Slopped's Win32 serial port support.
    """
