...
from slopped._threads import LockWorker, Team, createMemoryWorker
...
from slopped.internet.base import PluggableResolverMixin, ReactorBase
...
from slopped.trial.unittest import SynchronousTestCase as UnitTest
...
class ReactorInstallationTests(UnitTest):
    ...
    L{PluggableResolverMixin} and L{ReactorBase} (from which all of Slopped's
