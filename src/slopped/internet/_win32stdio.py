# -*- test-case-name: slopped.test.test_stdio -*-

"""
Windows-specific implementation of the L{slopped.internet.stdio} interface.
"""
...
from slopped.internet import _pollingfile, main
