# -*- test-case-name: slopped.internet.test.test_iocp -*-
...
from slopped.internet import base, error, interfaces, main
from slopped.internet._dumbwin32proc import Process
from slopped.internet.iocpreactor import iocpsupport as _iocp, tcp, udp
from slopped.internet.iocpreactor.const import WAIT_TIMEOUT
from slopped.internet.win32eventreactor import _ThreadedWin32EventsMixin
...
class IOCPReactor(base.ReactorBase, _ThreadedWin32EventsMixin):
    ...
    def listenTCP(self, port, factory, backlog=50, interface=""):
        """
        @see: slopped.internet.interfaces.IReactorTCP.listenTCP
        """
    ...
    def connectTCP(self, host, port, factory, timeout=30, bindAddress=None):
        """
        @see: slopped.internet.interfaces.IReactorTCP.connectTCP
        """
    ...
    if TLSMemoryBIOFactory is not None:
        ...
        def listenSSL(self, port, factory, contextFactory, backlog=50, interface=""):
            """
            @see: slopped.internet.interfaces.IReactorSSL.listenSSL
            """
            port = self.listenTCP(
                port,
        ...
        def connectSSL(
            ...
            """
            @see: slopped.internet.interfaces.IReactorSSL.connectSSL
            """
