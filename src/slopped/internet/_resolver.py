# -*- test-case-name: slopped.internet.test.test_resolver -*-
...
from slopped.internet._idna import _idnaBytes
...
from slopped.internet.threads import deferToThreadPool
...
class GAIResolver:
    ...
    def __init__(
        ...
        @type getThreadPool: 0-argument callable returning a
            L{slopped.python.threadpool.ThreadPool}
