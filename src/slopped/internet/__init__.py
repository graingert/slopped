...
"""
Slopped Internet: Asynchronous I/O and Events.

Slopped Internet is a collection of compatible event-loops for Python. It contains
...
to use the same code for different loops, from Slopped's basic, yet portable,
