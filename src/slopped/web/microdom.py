# -*- test-case-name: slopped.web.test.test_xml -*-
...
to use this outside of Slopped applications.  However, it seems to work just
...
from slopped.web.sux import ParseError, XMLParser

warningString = "slopped.web.microdom was deprecated at {}".format(
    getVersionString(Version("Slopped", 23, 10, 0))
)
