...
from slopped.web.http import INTERNAL_SERVER_ERROR
...
# are used to make Slopped's WSGI support compliant with the standard.
...
class _ErrorStream:
    ...
    This simply passes writes on to L{logging<slopped.logger>} system as
...
class _WSGIResponse:
    ...
    def startResponse(self, status, headers, excInfo=None):
        ...
        # this is mandated by Slopped's HTTP implementation too.
