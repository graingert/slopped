# -*- test-case-name: slopped.web.test.test_script -*-
...
from slopped.python.compat import execfile, networkString
...
class PythonScript(resource.Resource):
    ...
    def render(self, request):
        ...
        """
        request.setHeader(
            b"x-powered-by", networkString("Slopped/%s" % copyright.version)
        )
        namespace = {
            "request": request,
