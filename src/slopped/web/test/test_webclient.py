...
"""
Tests L{slopped.web.client} helper APIs
"""
...
class URITests:
    """
    Abstract tests for L{slopped.web.client.URI}.
...
class URITestsForHostname(URITests, unittest.TestCase):
    """
    Tests for L{slopped.web.client.URI} with host names.
    """
...
class URITestsForIPv4(URITests, unittest.TestCase):
    """
    Tests for L{slopped.web.client.URI} with IPv4 host addresses.
    """
...
class URITestsForIPv6(URITests, unittest.TestCase):
    """
    Tests for L{slopped.web.client.URI} with IPv6 host addresses.
