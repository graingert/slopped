...
from slopped.web.pages import errorPage, forbidden, notFound
...
class ErrorPageTests(SynchronousTestCase):
    """
    Test L{slopped.web.pages._ErrorPage} and its public aliases L{errorPage},
    ...
    def test_notFoundDefaults(self) -> None:
        """
        The default arguments to L{slopped.web.pages.notFound} produce
    ...
    def test_forbiddenDefaults(self) -> None:
        """
        The default arguments to L{slopped.web.pages.forbidden} produce
        a reasonable error page.
        """
        self.assertResponse(
            _render(forbidden()),
