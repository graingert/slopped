...
"""
Tests for L{slopped.web.http_headers}.
"""
...
from slopped.web.http_headers import Headers, InvalidHeaderName, _nameEncoder
...
class NameEncoderTests(SynchronousTestCase):
    """
    Test L{slopped.web.http_headers._NameEncoder}
    """
