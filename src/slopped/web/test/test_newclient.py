...
"""
Tests for L{slopped.web._newclient}.
"""
...
from slopped.internet.interfaces import IConsumer, IPushProducer
...
from slopped.web.http import _DataLoss
from slopped.web.http_headers import Headers
from slopped.web.iweb import IBodyProducer, IResponse
...
class ArbitraryException(Exception):
    """
    A unique, arbitrary exception type which L{slopped.web._newclient} knows
    nothing about.
    """
...
class HTTPClientParserTests(TestCase):
    ...
    def test_ignored1XXResponseCausesLog(self):
        """
        When a 1XX response is ignored, Slopped emits a log.
        """
        logObserver = EventLoggingObserver.createWithCleanup(self, globalLogPublisher)
        sample103Response = (
            b"HTTP/1.1 103 Early Hints\r\n"
