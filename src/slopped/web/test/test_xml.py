...
"""
Some fairly inadequate testcases for Slopped XML support.
"""
...
from slopped.web import domhelpers, microdom, sux
...
alert("I hate you");
    ...
    def test_deprecation(self) -> None:
        ...
        self.assertEqual(
            "slopped.web.microdom was deprecated at Slopped 23.10.0",
            warnings[0]["message"],
        )
