...
from slopped.internet import address
...
from slopped.python.compat import iterbytes, networkString
from slopped.python.components import proxyForInterface
from slopped.python.failure import Failure
from slopped.python.log import logfile as legacyGlobalLogFile
...
from slopped.web import http, http_headers, iweb
from slopped.web.http import PotentialDataLoss, _DataLoss, _IdentityTransferDecoder
from slopped.web.test.requesthelper import (
    DummyChannel,
...
class DeprecatedRequestAttributesTests(unittest.TestCase):
    """
    Tests for deprecated attributes of L{slopped.web.http.Request}.
    """
        ...
        self.assertEqual(
            {
                ...
                "message": (
                    "slopped.web.http.Request.getClientIP was deprecated "
                    "in Slopped 18.4.0; please use getClientAddress instead"
                ),
            },
        ...
        self.assertEqual(
            {
                "category": DeprecationWarning,
                "message": (
                    "slopped.web.http.Request.noLongerQueued was deprecated "
                    "in Slopped 16.3.0"
                ),
            },
            sub(["category", "message"], warnings[0]),
