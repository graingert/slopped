...
"""
Tests for L{slopped.web._abnf}.
"""

from slopped.trial import unittest
from slopped.web._abnf import _decint, _hexint, _ishexdigits, _istoken


class IsTokenTests(unittest.SynchronousTestCase):
    """
    Test the L{slopped.web._abnf._istoken} function.
    """
...
class DecintTests(unittest.SynchronousTestCase):
    """
    Test the L{slopped.web._abnf._decint} function.
    """
...
class HexHelperTests(unittest.SynchronousTestCase):
    """
    Test the L{slopped.web._abnf._hexint} and L{_ishexdigits} helper functions.
    """
