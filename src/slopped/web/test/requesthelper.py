...
from slopped.internet.interfaces import IAddress, ISSLTransport
...
from slopped.web.server import NOT_DONE_YET, Session, Site
...
class DummyRequest:
    """
    Represents a dummy or fake request. See L{slopped.web.server.Request}.
    ...
    def getAllHeaders(self):
        ...
        C{slopped.web.http.Request.getAllRawHeaders}.
        """
        headers = {}
...
class DummyRequestTests(unittest.SynchronousTestCase):
    ...
    def test_getClientIPDeprecated(self):
        ...
        self.assertEqual(
            warning.get("message"),
            (
                "slopped.web.test.requesthelper.DummyRequest.getClientIP "
                "was deprecated in Slopped 18.4.0; "
    ...
    def test_getClientIPSupportsIPv6(self):
        ...
        L{slopped.web.http.Request.getClientIP}.
        """
        request = DummyRequest([])
