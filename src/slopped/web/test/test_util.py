...
from slopped.web import resource, util
from slopped.web.error import FlattenerError
from slopped.web.http import FOUND
from slopped.web.server import Request
from slopped.web.template import TagLoader, flattenString, tags
from slopped.web.test.requesthelper import DummyChannel, DummyRequest
from slopped.web.util import (
    DeferredResource,
    FailureElement,
    ParentRedirect,
    _FrameElement,
...
class FormatFailureTests(TestCase):
    """
    Tests for L{slopped.web.util.formatFailure} which returns an HTML string
