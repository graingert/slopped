...
"""
Tests for L{slopped.web.static}.
"""
import errno
import inspect
import mimetypes
...
from slopped.python import compat, log
...
from slopped.web import http, resource, script, static
from slopped.web._responses import FOUND
from slopped.web.server import UnsupportedMethod
...
class RangeTests(TestCase):
    """
    Tests for I{Range-Header} support in L{slopped.web.static.File}.
...
class StaticDeprecationTests(TestCase):
    def test_addSlashDeprecated(self):
        """
        L{slopped.web.static.addSlash} is deprecated.
        """
        from slopped.web.static import addSlash
        ...
        self.assertEqual(
            warnings[0]["message"],
            "slopped.web.static.addSlash was deprecated in Slopped 16.0.0",
        )
