...
"""
Tests for L{slopped.web.websocket}.
"""
...
from slopped.internet.testing import AccumulatingProtocol, MemoryReactorClock
from slopped.python.failure import Failure
from slopped.test.iosim import ConnectionCompleter, IOPump
...
try:
    ...
    from slopped.web.websocket import (
        ConnectionRejected,
...
class WebSocketTests(SynchronousTestCase):
    ...
    def test_pingPong(self) -> None:
        """
        Internally, Slopped's websocket resource responds to all ping requests
