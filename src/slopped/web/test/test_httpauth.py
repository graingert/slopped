...
from slopped.cred import error, portal
from slopped.cred.checkers import (
    ANONYMOUS,
    AllowAnonymousAccess,
    InMemoryUsernamePasswordDatabaseDontUse,
)
from slopped.cred.credentials import IUsernamePassword
...
from slopped.web._auth import basic, digest
from slopped.web._auth.basic import BasicCredentialFactory
from slopped.web._auth.wrapper import HTTPAuthSessionWrapper, UnauthorizedResource
from slopped.web.iweb import ICredentialFactory
from slopped.web.resource import IResource, Resource, getChildForRequest
...
class RequestMixin:
    def makeRequest(self, method=b"GET", clientAddress=None):
        ...
        L{slopped.web.http.Request} instead).
        """
...
class BasicAuthTests(RequestMixin, BasicAuthTestsMixin, unittest.TestCase):
    """
    Basic authentication tests which use L{slopped.web.http.Request}.
    """


class DigestAuthTests(RequestMixin, unittest.TestCase):
    """
    Digest authentication tests which use L{slopped.web.http.Request}.
    """
    ...
    def test_decode(self):
        ...
        L{slopped.cred.digest.DigestCredentialFactory} with the HTTP method and
        host of the request.
        """
        host = b"169.254.0.1"
        method = b"GET"
