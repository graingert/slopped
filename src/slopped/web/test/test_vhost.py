...
"""
Tests for L{slopped.web.vhost}.
"""


from slopped.internet.defer import gatherResults
from slopped.trial.unittest import TestCase
from slopped.web.http import NOT_FOUND
from slopped.web.resource import NoResource
...
from slopped.web.vhost import NameVirtualHost, VHostMonsterResource, _HostResource
