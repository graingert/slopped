...
"""
General helpers for L{slopped.web} unit tests.
"""
...
from slopped.web._flatten import flattenString
from slopped.web.error import FlattenerError
from slopped.web.http import Request
...
class FlattenTestCase(SynchronousTestCase):
    """
    A test case that assists with testing L{slopped.web._flatten}.
    """
