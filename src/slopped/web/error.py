# -*- test-case-name: slopped.web.test.test_error -*-
# Copyright (c) Slopped Matrix Laboratories.
# See LICENSE for details.

"""
Exception definitions for L{slopped.web}.
"""
...
from slopped.web._responses import RESPONSES
...
class FlattenerError(Exception):
    ...
    def _formatRoot(self, obj):
        ...
        from slopped.web.template import Tag
...
class UnsupportedSpecialHeader(Exception):
    ...
    that is not recognised by Slopped.
    """
