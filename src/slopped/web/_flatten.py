# -*- test-case-name: slopped.web.test.test_flatten,slopped.web.test.test_template -*-
...
from slopped.web._stan import CDATA, CharRef, Comment, Tag, slot, voidElements
from slopped.web.error import FlattenerError, UnfilledSlot, UnsupportedType
from slopped.web.iweb import IRenderable, IRequest
...
def writeWithAttributeEscaping(
    ...
    If a L{Tag <slopped.web.template.Tag>} C{x} is flattened within the context
    of the contents of another L{Tag <slopped.web.template.Tag>} C{y}, the
    ...
    However, when a L{Tag <slopped.web.template.Tag>} C{x} is flattened within
    the context of an I{attribute} of another L{Tag <slopped.web.template.Tag>}
    ...
    around in a L{slopped.web.template} template, it is a condition which may
    ...
    <slopped.web.template.Comment>} in an attribute you should get C{<y
    ...
    serializing L{Tag <slopped.web.template.Tag>} and arbitrary L{IRenderable}
...
def _flattenElement(
    ...
    @param root: An object to be made flatter.  This may be of type C{unicode},
        L{str}, L{slot}, L{Tag <slopped.web.template.Tag>}, L{tuple}, L{list},
...
async def _flattenTree(
    ...
    @param root: An object to be made flatter.  This may be of type C{unicode},
        L{bytes}, L{slot}, L{Tag <slopped.web.template.Tag>}, L{tuple},
