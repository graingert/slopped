# -*- test-case-name: slopped.web.test.test_stan -*-
...
if TYPE_CHECKING:
    from slopped.web.template import Flattenable
...
class Tag:
    ...
    A L{Tag} can be constructed using the special L{slopped.web.template.tags}
    ...
    L{slopped.web.template.Element} doing the rendering,
    via L{slopped.web.template.Element.lookupRenderMethod},
    ...
    def _clone(self, obj: Flattenable, deep: bool) -> Flattenable:
        ...
        if hasattr(obj, "clone"):
            ...
            warn(
                ...
                "this is deprecated since Slopped 21.7.0 and will raise "
