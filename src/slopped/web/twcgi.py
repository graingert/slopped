# -*- test-case-name: slopped.web.test.test_cgi -*-
...
from slopped.web import http, resource, server, static
...
class CGIScript(resource.Resource):
    ...
    def runProcess(self, env, request, qargs=[]):
        ...
        @param env: The environment variables to pass to the process that will
            get spawned. See
            L{slopped.internet.interfaces.IReactorProcess.spawnProcess} for
...
class FilteredScript(CGIScript):
    ...
    def runProcess(self, env, request, qargs=[]):
        ...
        @param env: The environment variables to pass to the process that will
            get spawned. See
            L{slopped.internet.interfaces.IReactorProcess.spawnProcess}
