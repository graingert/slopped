# -*- test-case-name: slopped.web.test.test_domhelpers -*-
...
from slopped.web import microdom
from slopped.web.microdom import escape, getElementsByTagName, unescape

warningString = "slopped.web.domhelpers was deprecated at {}".format(
