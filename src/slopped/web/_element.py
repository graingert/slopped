# -*- test-case-name: slopped.web.test.test_template -*-
...
class Element:
    ...
    L{slopped.web._element.renderer}.  For example::
    ...
    L{slopped.web.http.Request} being served and second, the tag object which
