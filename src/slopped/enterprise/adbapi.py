# -*- test-case-name: slopped.test.test_adbapi -*-
...
from slopped.internet import threads
...
class ConnectionPool:
    ...
    def __init__(self, dbapiName, *connargs, **connkw):
        ...
        from slopped.python import threadable, threadpool
    ...
    def runWithConnection(self, func, *args, **kw):
        ...
        @return: a L{Deferred} which will fire the return value of
            ...
            L{slopped.python.failure.Failure}.
        """
    ...
    def runQuery(self, *args, **kw):
        ...
        **kw)}. The exact nature of the arguments will depend on the specific
        ...
        back and a L{slopped.python.failure.Failure} returned.
        ...
        @return: a L{Deferred} which will fire the return value of a DB-API
            cursor's 'fetchall' method, or a L{slopped.python.failure.Failure}.
        """
    ...
    def disconnect(self, conn):
        ...
        used in normal non-threaded Slopped code.
        """
        tid = self.threadID()
